...
[
  {
    "_id": {
      "$oid": "GENERATED_OBJECT_ID_TEST4_1"
    },
    "category": "aplus",
    "testId": 4,
...
Okay, here are the next 50 questions to complete Test 4 (Moderate Difficulty), bringing the total to 100:
...
[
  ...
  {
    "id": 62,
    "question": "A laser printer is printing pages with toner easily wiping off after printing. Which printer component is MOST likely malfunctioning?",
    "options": [
      "Toner Cartridge.",
      "Imaging Drum.",
    ...
    "correctAnswerIndex": 3,
    "explanation": "A faulty fuser assembly is MOST likely causing toner to wipe off easily after printing. The fuser assembly's job is to heat and press the toner onto the paper, permanently bonding it. If the fuser is not working correctly (insufficient heat or pressure), the toner will remain loose and easily smear or wipe off. Toner cartridge, imaging drum, and transfer belt/roller issues do not directly cause unfused toner.",
    "examTip": "If toner wipes off easily after laser printing, the fuser assembly is the prime suspect. It's responsible for 'fusing' the toner and making the print permanent."
  },
  {
    "id": 63,
...
[
  ...
  },
  {
    ...
    "options": [
      "Toner Cartridge (low toner)",
      "Fuser Assembly (uneven heating)",
      "Imaging Drum (scratch or obstruction)",
      "Laser Scanner Assembly (misalignment)"
    ],
    "correctAnswerIndex": 2,
    "explanation": "A scratch or obstruction on the Imaging Drum is MOST likely causing vertical white lines or missing print. A defect on the drum's surface can prevent toner from being attracted to that area, resulting in a vertical line of missing print. Low toner typically causes faded prints, fuser issues cause smearing, and laser scanner misalignment might cause more general print distortion, not typically clean vertical white lines.",
    "examTip": "Vertical white lines or missing print in laser prints often indicate a scratch or obstruction on the imaging drum surface. Inspect the drum for physical defects."
  },
  {
    "id": 73,
  ...
  },
  {
    ...
    "correctAnswerIndex": 2,
    "explanation": "Implementing account lockout policies and strong password complexity requirements is a BEST practice to protect against brute-force password attacks. Account lockout policies automatically lock accounts after multiple failed login attempts, thwarting brute-force attacks. Strong passwords make guessing passwords harder. Sharing passwords or weak passwords are security risks, and disabling lockout policies increases vulnerability.",
  ...
  },
  {
    ...
    "correctAnswerIndex": 1,
    "explanation": "Port 1434 (UDP) is used by Microsoft SQL Server Browser service. SQL Server Browser listens on UDP port 1434 and responds to client requests for SQL Server instance information, helping clients locate SQL Server instances dynamically, especially named instances. Port 1433 is for SQL Server default instance, Port 1521 for Oracle, and Port 3306 for MySQL.",
  ...
  {
    "id": 90,
    "question": "A technician wants to implement 'port mirroring' on a managed switch. What is the primary purpose of port mirroring?",
    "options": [
      "To increase network bandwidth.",
      "To improve network security by blocking malicious traffic.",
      "To duplicate network traffic from one or more ports to a monitoring port for analysis.",
      "To prioritize network traffic for certain applications."
    ],
    "correctAnswerIndex": 2,
    "explanation": "Port mirroring is primarily used to duplicate network traffic from one or more ports to a monitoring port for analysis. This allows network administrators to capture and inspect network traffic for troubleshooting, security monitoring, or performance analysis. Port mirroring does not increase bandwidth, block malicious traffic (that's firewalling or IDS/IPS), or prioritize traffic (that's QoS).",
    "examTip": "Port mirroring (or SPAN - Switched Port Analyzer) is for network monitoring and analysis. It lets you 'copy' traffic from live network links to a dedicated port for tools like Wireshark to analyze."
  },
  {
    "id": 91,
