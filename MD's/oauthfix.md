...
so to get you up tot date- my oauth seesm to actualy work- hwoever teh redirection/sign in is not nesscialry working (teh actyal oauth isgn in works but not the my applciation "sign in") so after registering it should direct you to either teh porilfe automcially bvaue most web apps with oauth do that to hwere you automcially get signed in if you regsiter with an oauth provider like google- however that shoudl not be for normal regisetring if you regsiter trhough teh actual regsiter thing liek with username,email, password, confirm password because its good fo rthem to verify again tehy enetered evryhthing correctly and direct them to login to sign in with the info tehy just regsitered with, so for oauth we should just automcialy sign them in after regsiting so we need ot fix that apsect of teh registering with oauth (liek google and apple),---also since i asssume users dont want theri usernaem to be their name from thei email/google info lets make a web page rigth before the proifile where they create  username- liek ity shoudl be just a box in the middle where it asks them to create a username with text tahts ays tehy can alwwsy chnaeg it if theyd like- then once htey creaet yen username they get redirected to profile- so i walk through the scenario. teh user laods up my resgiter page an dclciks signup/registrr with google, they do the google oauth and once usccesful it then directs them to a page to create asueranme- then once they created teh username it directs them to the porilfe? (keep in mind ill in teh future set up stripe so they pay $10 but idk hwo ot go about thta just yet), also however teh sign in aspect for oauth (liek google and appl) shoudl still work becaue if they log out(because if they log in the browser keeps them logged in), or if they go on a differetn brower or device or whatver they need to sign in again so the oauth should work on that end aswell. and right now both ar ejust redirecting me to the info page (which is teh root path /) instead of the profile page after regsierting( but for regsietreing it will be iusername creation poage then profile- (and after signing in saem aswell but remeber since if tehy regsiter with oauth it shoudl automcially sign them in----dont do that for regualr registering liek without oauth)

and all this shoud lapply to both Oauth providers which is google and apple adn jst do it liek every other wp page usually does it liek how oauth automcially sigsn them in after "registering" and also you shoudl be bale ot sign in with tit without typing in the actual username or email and password because outh does that fro you tahst wthe whoel point lol.
and since when they reosdguter they dotn make a username (needed for leaderbaord and stuff) right now my ccode create oen fro them based on theri gmail/info so intsead we just replace that with teh username creation paeg after oauth sucess


so ill provid eyou some docker logs of when try i register and sign in   
so here are some docker logs of me regsiertring an accoutn with oauth -liek what happens after
and also signing in with ouath --liek what happens after

regsiering with oauth
| 2025-03-08 05:44:16,012 - app - INFO - Handling request to /oauth/auth/google with method GET
backend_service      | 2025-03-08 05:44:16,014 - urllib3.connectionpool - DEBUG - Starting new HTTPS connection (1): accounts.google.com:443
backend_service      | 2025-03-08 05:44:16,092 - urllib3.connectionpool - DEBUG - https://accounts.google.com:443 "POST /o/oauth2/token HTTP/1.1" 200 None
backend_service      | 2025-03-08 05:44:16,096 - urllib3.connectionpool - DEBUG - Starting new HTTPS connection (1): www.googleapis.com:443
backend_service      | 2025-03-08 05:44:16,155 - urllib3.connectionpool - DEBUG - https://www.googleapis.com:443 "GET /oauth2/v1/userinfo HTTP/1.1" 200 None
backend_service      | 2025-03-08 05:44:16,156 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,156 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,157 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,157 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 0.00020048092119395733}
backend_service      | 2025-03-08 05:44:16,157 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"find\": \"mainusers\", \"filter\": {\"email\": \"cartertechsolution@gmail.com\"}, \"limit\": 1, \"singleBatch\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412639, \"i\": 56}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wxS0SiDkqoCZqF8ROizmnFxJKyM=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"$db\": \"xploitcraft\"}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 619290071, "operationId": 619290071, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,161 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 4.298, "reply": "{\"cursor\": {\"ns\": \"xploitcraft.mainusers\"}, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 16}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 16}}}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 619290071, "operationId": 619290071, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,161 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:44:16,162 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,162 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,162 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,162 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 7.51999905332923e-05}
backend_service      | 2025-03-08 05:44:16,162 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"find\": \"mainusers\", \"filter\": {\"username\": \"carter\"}, \"limit\": 1, \"singleBatch\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 16}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"$db\": \"xploitcraft\"}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 707900973, "operationId": 707900973, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,166 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 3.9430000000000005, "reply": "{\"cursor\": {\"firstBatch\": [{\"_id\": {\"$oid\": \"67cb807a92a818005b647cec\"}, \"username\": \"carter\", \"email\": \"carterperez-dev@proxyauthrequired.com\", \"oauth_provider\": \"google\", \"google_id\": \"111445565516540333447\", \"level\": 1, \"xpBoost\": 1.0, \"currentAvatar\": {\"$oid\": \"67c8019eafc1b9f001544ccb\"}, \"purchasedItems\": [{\"$oid\": \"67c8019eafc1b9f001544ccb\"}], \"achievement_counters\": {\"lowest_score_ever\": 100.0}}], \"ns\": \"xploitcraft.mainusers\"}, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 16}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 16}}}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 707900973, "operationId": 707900973, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,166 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:44:16,167 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,167 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,167 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,167 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 7.019995246082544e-05}
backend_service      | 2025-03-08 05:44:16,167 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"find\": \"mainusers\", \"filter\": {\"username\": \"carter1\"}, \"limit\": 1, \"singleBatch\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 16}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"$db\": \"xploitcraft\"}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 407487131, "operationId": 407487131, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,171 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 4.111, "reply": "{\"cursor\": {\"ns\": \"xploitcraft.mainusers\"}, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 407487131, "operationId": 407487131, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,171 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:44:16,171 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,172 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,172 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,172 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 6.6359993070364e-05}
backend_service      | 2025-03-08 05:44:16,172 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"find\": \"mainusers\", \"filter\": {\"$or\": [{\"username\": \"carter1\"}, {\"email\": \"cartertechsolution@gmail.com\"}]}, \"limit\": 1, \"singleBatch\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"$db\": \"xploitcraft\"}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 2113903881, "operationId": 2113903881, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,176 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 3.885, "reply": "{\"cursor\": {\"ns\": \"xploitcraft.mainusers\"}, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 2113903881, "operationId": 2113903881, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,176 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:44:16,176 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,176 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,176 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,176 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 6.211991421878338e-05}
backend_service      | 2025-03-08 05:44:16,177 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"find\": \"shopItems\", \"filter\": {\"type\": \"avatar\"}, \"limit\": 1, \"singleBatch\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"$db\": \"xploitcraft\"}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 7684930, "operationId": 7684930, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,180 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 3.76, "reply": "{\"cursor\": {\"firstBatch\": [{\"_id\": {\"$oid\": \"67c8019eafc1b9f001544ccb\"}, \"type\": \"avatar\", \"title\": \"Default\", \"description\": \"Default Avatar\", \"imageUrl\": \"/avatars/avatar1.png\", \"unlockLevel\": 1}], \"ns\": \"xploitcraft.shopItems\"}, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 7684930, "operationId": 7684930, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,181 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:44:16,181 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,181 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,181 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,181 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 9.159999899566174e-05}
backend_service      | 2025-03-08 05:44:16,181 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"insert\": \"mainusers\", \"ordered\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"txnNumber\": 29, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 17}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"writeConcern\": {\"w\": \"majority\"}, \"$db\": \"xploitcraft\", \"documents\": [{\"username\": \"carter1\", \"email\": \"cartertechsolution@gmail.com\", \"oauth_provider\": \"google\", \"google_id\": \"107041076753128308892\", \"level\": 1, \"xpBoost\": 1.0, \"currentAvatar\": {\"$oid\": \"67c8019eafc1b9f001544ccb\"}, \"purchasedItems\": [{\"$oid\": \"67c8019eafc1b9f001544ccb\"}], \"achievement_counters\": {\"lowest_score_ever\": 100.0}, \"_id\": {\"$oid\": \"67cbd930ba0f73be674dace5\"}}]}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 1776808933, "operationId": 1776808933, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,188 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 6.961, "reply": "{\"n\": 1, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 19}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 19}}}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 1776808933, "operationId": 1776808933, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,188 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:44:16,189 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,189 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,189 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,189 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 8.495990186929703e-05}
backend_service      | 2025-03-08 05:44:16,189 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"insert\": \"auditLogs\", \"ordered\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"txnNumber\": 30, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 19}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"writeConcern\": {\"w\": \"majority\"}, \"$db\": \"xploitcraft\", \"documents\": [{\"timestamp\": {\"$date\": \"2025-03-08T05:44:16.189Z\"}, \"userId\": {\"$oid\": \"67cbd930ba0f73be674dace5\"}, \"ip\": \"172.18.0.2\", \"success\": true, \"provider\": \"google\", \"_id\": {\"$oid\": \"67cbd930ba0f73be674dace6\"}}]}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 711845894, "operationId": 711845894, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,195 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 6.074999999999999, "reply": "{\"n\": 1, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 20}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 20}}}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 711845894, "operationId": 711845894, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,196 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:44:16,198 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:44:16,198 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,198 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:44:16,199 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 8.299993351101875e-05}
backend_service      | 2025-03-08 05:44:16,199 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"insert\": \"perfSamples\", \"ordered\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"txnNumber\": 31, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 20}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"writeConcern\": {\"w\": \"majority\"}, \"$db\": \"xploitcraft\", \"documents\": [{\"route\": \"/oauth/auth/google\", \"method\": \"GET\", \"duration_sec\": 0.18534421920776367, \"response_bytes\": 361, \"http_status\": 302, \"timestamp\": {\"$date\": \"2025-03-08T05:44:16.198Z\"}, \"_id\": {\"$oid\": \"67cbd930ba0f73be674dace7\"}}]}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 404158660, "operationId": 404158660, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,205 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 6.159999999999999, "reply": "{\"n\": 1, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 21}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"wJsXnfxrDGN7HJuZGIcDyYwlOOk=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412656, \"i\": 21}}}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 404158660, "operationId": 404158660, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:44:16,205 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
nginx_proxy          | 104.23.187.80 - - [08/Mar/2025:05:44:16 +0000] "GET /api/oauth/auth/google?state=3jydwe5E5EINre-wMxkkvA&code=4%2F0AQSTgQFk9VDdvF_0IPGM7JZHx80631iyBEBalJSOk9froU5J-DFVZdMnWKcJqVv8tlcUeQ&scope=email+profile+openid+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.profile+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email&authuser=1&prompt=consent HTTP/1.1" 302 361 "https://accounts.google.com/" "Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0" "2600:4040:b086:9100:4e01:523c:601d:393"
frontend_service     |  HTTP  3/8/2025 5:44:16 AM 172.18.0.2 GET /oauth/success?provider=google&userId=67cbd930ba0f73be674dace5
frontend_service     |  HTTP  3/8/2025 5:44:16 AM 172.18.0.2 Returned 200 in 1 ms
nginx_proxy          | 104.23.187.80 - - [08/Mar/2025:05:44:16 +0000] "GET /oauth/success?provider=google&userId=67cbd930ba0f73be674dace5 HTTP/1.1" 200 523 "https://accounts.google.com/" "Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0" "2600:4040:b086:9100:4e01:523c:601d:393"


now here is me "siging in" with oauth from terh regsiering i just did 

| 104.23.187.80 - - [08/Mar/2025:05:45:18 +0000] "GET /api/oauth/login/google HTTP/1.1" 302 729 "https://certgames.com/login" "Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0" "2600:4040:b086:9100:4e01:523c:601d:393"
backend_service      | 2025-03-08 05:45:23,455 - app - INFO - Handling request to /oauth/auth/google with method GET
backend_service      | 2025-03-08 05:45:23,456 - urllib3.connectionpool - DEBUG - Starting new HTTPS connection (1): accounts.google.com:443
backend_service      | 2025-03-08 05:45:23,518 - urllib3.connectionpool - DEBUG - https://accounts.google.com:443 "POST /o/oauth2/token HTTP/1.1" 200 None
backend_service      | 2025-03-08 05:45:23,521 - urllib3.connectionpool - DEBUG - Starting new HTTPS connection (1): www.googleapis.com:443
backend_service      | 2025-03-08 05:45:23,572 - urllib3.connectionpool - DEBUG - https://www.googleapis.com:443 "GET /oauth2/v1/userinfo HTTP/1.1" 200 None
backend_service      | 2025-03-08 05:45:23,573 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:45:23,573 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "Primary()", "operation": "find", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:45:23,573 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:45:23,573 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 0.00021548010408878326}
backend_service      | 2025-03-08 05:45:23,573 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"find\": \"mainusers\", \"filter\": {\"email\": \"cartertechsolution@gmail.com\"}, \"limit\": 1, \"singleBatch\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412718, \"i\": 88}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"XaAbAPQ4udCIb0UiYtU+4311SRM=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"$db\": \"xploitcraft\"}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 822262754, "operationId": 822262754, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:45:23,578 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 4.101, "reply": "{\"cursor\": {\"firstBatch\": [{\"_id\": {\"$oid\": \"67cbd930ba0f73be674dace5\"}, \"username\": \"carter1\", \"email\": \"cartertechsolution@gmail.com\", \"oauth_provider\": \"google\", \"google_id\": \"107041076753128308892\", \"level\": 1, \"xpBoost\": 1.0, \"currentAvatar\": {\"$oid\": \"67c8019eafc1b9f001544ccb\"}, \"purchasedItems\": [{\"$oid\": \"67c8019eafc1b9f001544ccb\"}], \"achievement_counters\": {\"lowest_score_ever\": 100.0}}], \"ns\": \"xploitcraft.mainusers\"}, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 59}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"5EAj83W8Z5lryh+qIdre47g8A+A=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 59}}}", "commandName": "find", "databaseName": "xploitcraft", "requestId": 822262754, "operationId": 822262754, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:45:23,578 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:45:23,578 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:45:23,578 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:45:23,578 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:45:23,578 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 7.099995855242014e-05}
backend_service      | 2025-03-08 05:45:23,579 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"insert\": \"auditLogs\", \"ordered\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"txnNumber\": 36, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 59}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"5EAj83W8Z5lryh+qIdre47g8A+A=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"writeConcern\": {\"w\": \"majority\"}, \"$db\": \"xploitcraft\", \"documents\": [{\"timestamp\": {\"$date\": \"2025-03-08T05:45:23.578Z\"}, \"userId\": {\"$oid\": \"67cbd930ba0f73be674dace5\"}, \"ip\": \"172.18.0.2\", \"success\": true, \"provider\": \"google\", \"_id\": {\"$oid\": \"67cbd973ba0f73be674dacec\"}}]}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 648031326, "operationId": 648031326, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:45:23,585 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 5.922000000000001, "reply": "{\"n\": 1, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 63}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"5EAj83W8Z5lryh+qIdre47g8A+A=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 62}}}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 648031326, "operationId": 648031326, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:45:23,585 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
backend_service      | 2025-03-08 05:45:23,586 - pymongo.serverSelection - DEBUG - {"message": "Server selection started", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}}
backend_service      | 2025-03-08 05:45:23,587 - pymongo.serverSelection - DEBUG - {"message": "Server selection succeeded", "selector": "<function writable_server_selector at 0xf5ba6e0d4040>", "operation": "insert", "topologyDescription": "<TopologyDescription id: 67cbd669ba0f73be674dacc9, topology_type: LoadBalanced, servers: [<ServerDescription ('ac-75jlsm4-lb.nmo0cjq.mongodb.net', 27017) server_type: LoadBalancer, rtt: None>]>", "clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:45:23,587 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checkout started", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017}
backend_service      | 2025-03-08 05:45:23,587 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked out", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1, "durationMS": 7.992004975676537e-05}
backend_service      | 2025-03-08 05:45:23,587 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command started", "command": "{\"insert\": \"perfSamples\", \"ordered\": true, \"lsid\": {\"id\": {\"$binary\": {\"base64\": \"ITmKqwG6QEeUy5y7Wr1t2Q==\", \"subType\": \"04\"}}}, \"txnNumber\": 37, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 63}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"5EAj83W8Z5lryh+qIdre47g8A+A=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"writeConcern\": {\"w\": \"majority\"}, \"$db\": \"xploitcraft\", \"documents\": [{\"route\": \"/oauth/auth/google\", \"method\": \"GET\", \"duration_sec\": 0.13131952285766602, \"response_bytes\": 361, \"http_status\": 302, \"timestamp\": {\"$date\": \"2025-03-08T05:45:23.586Z\"}, \"_id\": {\"$oid\": \"67cbd973ba0f73be674daced\"}}]}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 1411154259, "operationId": 1411154259, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:45:23,593 - pymongo.command - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Command succeeded", "durationMS": 5.842, "reply": "{\"n\": 1, \"ok\": 1.0, \"$clusterTime\": {\"clusterTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 67}}, \"signature\": {\"hash\": {\"$binary\": {\"base64\": \"5EAj83W8Z5lryh+qIdre47g8A+A=\", \"subType\": \"00\"}}, \"keyId\": 7447541950611193963}}, \"operationTime\": {\"$timestamp\": {\"t\": 1741412723, \"i\": 65}}}", "commandName": "insert", "databaseName": "xploitcraft", "requestId": 1411154259, "operationId": 1411154259, "driverConnectionId": 1, "serverConnectionId": 23996, "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "serviceId": "67be14c6c70fe18a81a5923d"}
backend_service      | 2025-03-08 05:45:23,593 - pymongo.connection - DEBUG - {"clientId": {"$oid": "67cbd669ba0f73be674dacc9"}, "message": "Connection checked in", "serverHost": "ac-75jlsm4-lb.nmo0cjq.mongodb.net", "serverPort": 27017, "driverConnectionId": 1}
nginx_proxy          | 104.23.187.80 - - [08/Mar/2025:05:45:23 +0000] "GET /api/oauth/auth/google?state=-zHUgLOa-oZSdmPHNXg2JQ&code=4%2F0AQSTgQG73gATKhIPIyXTMWsA8K1XIv7VFNKH6nhLgROb-SfARAw6_8n8fluXNvklzvCtsQ&scope=email+profile+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.profile+openid+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email&authuser=1&prompt=none HTTP/1.1" 302 361 "https://accounts.google.com/" "Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0" "2600:4040:b086:9100:4e01:523c:601d:393"
frontend_service     |  HTTP  3/8/2025 5:45:23 AM 172.18.0.2 GET /oauth/success?provider=google&userId=67cbd930ba0f73be674dace5
frontend_service     |  HTTP  3/8/2025 5:45:23 AM 172.18.0.2 Returned 200 in 2 ms
nginx_proxy          | 104.23.187.80 - - [08/Mar/2025:05:45:23 +0000] "GET /oauth/success?provider=google&userId=67cbd930ba0f73be674dace5 HTTP/1.1" 200 523 "https://accounts.google.com/" "Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0" "2600:4040:b086:9100:4e01:523c:601d:393"
...
so lets start with backend- ands keep in mind we ddi soem uincovential things becasue of my reverse proxy adn redirection issues and stuff liek that so make sure to keep all fucntility and stuff other than what needs to be fixed to fix what i said above. dont go out of the way top fix anything irrlevant ro nything liek that.-im pretty usr eit might be frotnedn issues anyway but i coudl be wrong lol
...
--now tis test routes file contaisn good context becasue it  has stuff like user route and login route
# ================================
# test_routes.py
# ================================
...
this file is good context aswell
# models/test.py
from bson.objectid import ObjectId
from datetime import datetime, timedelta
...
this file is good conetxt aswell"
##################################
...
now hhere is teh actual oauth routes
...
her ei suserprofile and userslice files for context
...
also for addiotnal context i will porvide teh reverse proxy nginx conffig aswell as my aapche server config
...
ok so go ahead and do/fix what i said in the prompt please- hoepfully i porvide dyou with all teh nessciayr files to undertand and good ocntext 
