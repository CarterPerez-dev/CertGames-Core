// src/components/pages/cissp/CisspTestPage.js
...
// Import the matching test list component for CISSP
...
/* ------------------------------------------------------------------
   Main Component: CisspTestPage
   If no :testId => show test list,
   else show the Test View
------------------------------------------------------------------ */
const CisspTestPage = () => {
  const { testId } = useParams();
  return testId ? <TestView testId={testId} /> : <CisspTestList />;
};
...
const TestView = ({ testId }) => {
  ...
  useEffect(() => {
    ...
    const progress = {
      ...
      score,
      totalQuestions,
      category: currentTest?.category || "cissp",
      ...
      <div className="score-overlay">
        <div className="score-content">
          ...
          <div className="overlay-buttons">
            ...
            {/* Link back to /practice-tests/cissp */}
            <button
              className="back-btn"
              onClick={() => navigate("/practice-tests/cissp")}
            >
              Back to Test List
            </button>
            {Number(testId) < 9999 && (
              <button
                ...
                onClick={() =>
                  navigate(`/practice-tests/cissp/${Number(testId) + 1}`)
                }
              >
                Next Test
              </button>
  ...
  return error ? (
    ...
    <div className="cissp-test-container">
      ...
      <div className="upper-control-bar">
        ...
        <button className="back-btn" onClick={() => navigate("/practice-tests/cissp")}>
          Back to Test List
        </button>
      </div>

      <h1 className="cissp-title">{currentTest.testName}</h1>
