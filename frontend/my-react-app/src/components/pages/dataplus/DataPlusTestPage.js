// src/components/pages/dataplus/DataPlusTestPage.js
...
// Import the matching test list component for Data+
...
/* ------------------------------------------------------------------
   Main Component: DataPlusTestPage
   If no :testId => show test list,
   else show the Test View
------------------------------------------------------------------ */
const DataPlusTestPage = () => {
  const { testId } = useParams();
  return testId ? <TestView testId={testId} /> : <DataPlusTestList />;
};
...
const TestView = ({ testId }) => {
      ...
      try {
        ...
        if (savedProgressStr) {
          ...
          const initProgress = {
            ...
            category: data.category || "dataplus",
  ...
  useEffect(() => {
    ...
    const progress = {
      ...
      score,
      totalQuestions,
      category: currentTest?.category || "dataplus",
  ...
  /* ------------------------------------------------------------------
     (7) Memoized Filtered Questions for Review
  ------------------------------------------------------------------ */
      ...
      <div className="score-overlay">
        <div className="score-content">
          ...
          <div className="overlay-buttons">
            ...
            {/* Navigate back to /practice-tests/data-plus */}
            <button
              className="back-btn"
              onClick={() => navigate("/practice-tests/data-plus")}
            >
              Back to Test List
            </button>
            {Number(testId) < 9999 && (
              <button
                ...
                onClick={() =>
                  navigate(`/practice-tests/data-plus/${Number(testId) + 1}`)
                }
              >
                Next Test
              </button>
  ...
  return error ? (
    ...
    <div className="dataplus-test-container">
      ...
      <h1 className="dataplus-title">{currentTest.testName}</h1>
