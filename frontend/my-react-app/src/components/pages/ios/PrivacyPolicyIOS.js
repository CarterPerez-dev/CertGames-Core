// src/components/pages/ios/PrivacyPolicyIOS.js
import React, { useState, useEffect } from 'react';
import { FaInfoCircle, FaBook, FaLock, FaExternalLinkAlt } from 'react-icons/fa';
import './AppleLegalPages.css';

const PrivacyPolicyIOS = () => {
  const [activeSection, setActiveSection] = useState('');

  // Update active section based on scroll position
  useEffect(() => {
    const handleScroll = () => {
      const sections = document.querySelectorAll('.apple-legal-section');
      let currentSection = '';
  ...
  return (
    <div className="apple-legal-container">
      <div className="apple-legal-header-accent"></div>
      <div className="apple-legal-content">
        <div className="apple-legal-document-header">
          <FaLock className="apple-legal-header-icon" />
          <div className="apple-legal-title-wrapper">
            <h1 className="apple-legal-title">Privacy Policy</h1>
            <p className="apple-legal-date">Last updated: March 30, 2025</p>
          </div>
        </div>
        
        <div className="apple-legal-summary-card">
          <div className="apple-legal-summary-header">
            <FaInfoCircle className="apple-legal-summary-icon" />
        ...
        {/* Table of Contents */}
        <div className="apple-legal-toc-container">
          <div className="apple-legal-toc">
            <div className="apple-legal-toc-header">
              <FaBook className="apple-legal-toc-icon" />
              <div className="apple-legal-toc-title">Table of Contents</div>
            </div>
            <ul className="apple-legal-toc-list">
              {sections.map((section) => (
                <li key={section.id} className={activeSection === section.id ? 'apple-legal-active-section' : ''}>
        ...
        <div className="apple-legal-document-body">
          <section id="introduction" className="apple-legal-section">
            <h2>1. Introduction</h2>
            <div className="apple-legal-section-content">
              <p>
          ...
          <section id="information" className="apple-legal-section">
            ...
            <div className="apple-legal-section-content">
              ...
              <ul className="apple-legal-list">
                ...
                <li><strong>Authentication Information:</strong> When you sign in using Google or Ouath, we receive basic profile information such as your name and email address.</li>
                <li><strong>Usage Data:</strong> Information about how you interact with our app, including tests taken, scores, achievements, and usage patterns.</li>
          ...
          <section id="use" className="apple-legal-section">
          ...
          <section id="share" className="apple-legal-section">
            ...
            <div className="apple-legal-section-content">
              ...
              <div className="apple-legal-callout">
          ...
          <section id="security" className="apple-legal-section">
          ...
          <section id="rights" className="apple-legal-section">
          ...
          <section id="cookies" className="apple-legal-section">
          ...
          <section id="authentication" className="apple-legal-section">
              ...
              <ul className="apple-legal-list">
                <li>
                  <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">
                    Google Privacy Policy <FaExternalLinkAlt className="apple-legal-external-link-icon" />
                  </a>
                </li>
                <li>
                  <a href="https://www.apple.com/legal/privacy/" target="_blank" rel="noopener noreferrer">
                    Apple Privacy Policy <FaExternalLinkAlt className="apple-legal-external-link-icon" />
                  </a>
                </li>
              </ul>
            </div>
          ...
          <section id="children" className="apple-legal-section">
          ...
          <section id="international" className="apple-legal-section">
          ...
          <section id="retention" className="apple-legal-section">
          ...
          <section id="changes" className="apple-legal-section">
          ...
          <section id="contact" className="apple-legal-section">
            <h2>13. Contact Us</h2>
            <div className="apple-legal-section-content">
              <p>
                If you have any questions about this Privacy Policy, please contact us at:
              </p>
              <div className="apple-legal-contact-info">
                <p>
...
export default PrivacyPolicyIOS;
