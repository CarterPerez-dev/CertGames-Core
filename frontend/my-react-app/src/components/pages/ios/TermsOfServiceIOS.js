// src/components/pages/ios/TermsOfServiceIOS.js
import React, { useState, useEffect } from 'react';
import { FaInfoCircle, FaBook, FaScroll, FaExternalLinkAlt } from 'react-icons/fa';
import './AppleLegalPages.css';

const TermsOfServiceIOS = () => {
    ...
    <div className="apple-legal-container">
      ...
      <div className="apple-legal-content">
        <div className="apple-legal-document-header">
          <FaScroll className="apple-legal-header-icon" />
          <div className="apple-legal-title-wrapper">
            <h1 className="apple-legal-title">Terms of Service</h1>
        ...
        <div className="apple-legal-document-body">
          <section id="acceptance" className="apple-legal-section">
          ...
          <section id="registration" className="apple-legal-section">
          ...
          <section id="subscription" className="apple-legal-section">
          ...
          <section id="conduct" className="apple-legal-section">
          ...
          <section id="ip" className="apple-legal-section">
          ...
          <section id="third-party" className="apple-legal-section">
              ...
              <ul className="apple-legal-list">
                <li>
                  <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer">
                    Google Terms of Service <FaExternalLinkAlt className="apple-legal-external-link-icon" />
                  </a>
                </li>
                <li>
                  <a href="https://www.apple.com/legal/internet-services/itunes/us/terms.html" target="_blank" rel="noopener noreferrer">
                    Apple Terms of Service <FaExternalLinkAlt className="apple-legal-external-link-icon" />
                  </a>
                </li>
              </ul>
            </div>
          ...
          <section id="disclaimer" className="apple-legal-section">
            <h2>8. Disclaimer of Warranties</h2>
            <div className="apple-legal-section-content">
              <p className="apple-legal-important">
          ...
          <section id="liability" className="apple-legal-section">
          ...
          <section id="termination" className="apple-legal-section">
          ...
          <section id="governing-law" className="apple-legal-section">
