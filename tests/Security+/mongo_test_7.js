  ...
  "questions": [
      ...
      "id": 9,
        ...
        "options": [
          "Moving data from one server to another within a data center.",
            "The techniques an attacker uses to move through a compromised network, gaining access to additional systems and data after the initial compromise.",
    ...
    },
    {
      "id": 35,
       ...
       "examTip": "CSRF attacks can be mitigated by using anti-CSRF tokens (unique, secret values in each request) and checking HTTP Referer headers."
    },
     {
        "id": 36,
    ...
    },
    {
    ...
    },
     {
        ...
        "question": "What is a common technique used to mitigate 'cross-site request forgery' (CSRF) attacks?",
         ...
         "correctAnswerIndex": 1,
        "explanation": "Anti-CSRF tokens ensure that requests originate from the legitimate web application and not from an attacker. While the other options are good security practices, they don't *directly* address the CSRF vulnerability.  Strong passwords protect accounts, encryption protects data in transit, firewalls control network access.",
    ...
    },
     {
      ...
      },
      {
        ...
        "question": "Which of the following is a key benefit of using a Security Information and Event Management (SIEM) system?",
         ...
         "correctAnswerIndex": 1,
          "explanation": "SIEM systems aggregate security logs and events from across an organization, providing a central point for monitoring, analysis, and incident response. While some SIEMs *might* integrate with other tools (for patching, etc.), their *core* function is centralized monitoring and analysis.",
      ...
      },
      {
        ...
        "examTip": "Security systems should be tuned to minimize both false positives (false alarms) and false negatives (missed detections).  False negatives are often more dangerous."
      },
      {
         "id": 61,
    ...
    },
    {
    ...
    },
     {
      ...
      "correctAnswerIndex": 1,
      "explanation": "A WAF is specifically designed to protect *web applications* by inspecting HTTP traffic and blocking malicious requests based on predefined rules, signatures, and anomaly detection. It's a *specialized* firewall, *not* a general-purpose firewall, encryption tool, or user management system.",
    ...
    },
    {
    ...
    },
     {
        ...
        "options":[
         ...
         "correctAnswerIndex": 2,
        "explanation": "ROP is a sophisticated *technical* exploit that allows attackers to execute code even when defenses against traditional code injection (like Data Execution Prevention - DEP and Address Space Layout Randomization - ASLR) are in place.  It's *not* about secure coding, social engineering, or encryption.",
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation": "User input fields, like comment sections, are prime targets for XSS attacks. Attackers can inject malicious client-side scripts that will be executed by the browsers of *other users* who visit the page. DoS attacks availability; MitM intercepts communications; brute force targets passwords. While those *could* be relevant, XSS is the *direct* vulnerability related to user-submitted content.",
