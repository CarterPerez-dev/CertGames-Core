db.tests.insertOne({
  ...
  "questions": [
    ...
    },
    {
      ...
      "correctAnswerIndex": 2,
      "explanation": "MFA requires at least two different factors: something you know (password), something you have (phone, token), or something you are (biometric). Option C uses a password (know) and either a biometric (are) or a hardware token (have), providing the strongest combination. SMS codes (option B) are better than just a password, but are vulnerable to SIM swapping and other attacks. Security questions (option A) are both 'something you know' and are often easily guessable. Two passwords (option D) are still just 'something you know'.",
    ...
    },
    {
      ...
      "examTip": "Security through obscurity can be used as one layer in a defense-in-depth strategy, but it should never be the primary security mechanism."
    },
    {
      "id": 19,
    ...
    {
      "id": 41,
      "question": "Which of the following is the MOST effective technique for mitigating the risk of return-oriented programming (ROP) attacks?",
      "options": [
        "Strong passwords.",
      ...
      "correctAnswerIndex": 1,
      "explanation": "ROP is an advanced exploitation technique that bypasses traditional defenses like DEP. ROP chains together existing code snippets (gadgets) already present in memory. While ASLR and DEP make ROP more difficult, they are not foolproof. Code randomization (making the location of gadgets unpredictable) and integrity checks (verifying that code hasn't been tampered with) are more effective defenses. Strong passwords, input validation, and firewalls address different attack vectors.",
    ...
    },
    {
      ...
      "correctAnswerIndex": 1,
      "explanation": "SOAR platforms help security teams work more efficiently and effectively. They automate repetitive tasks, integrate different security tools (like SIEM, threat intelligence feeds, endpoint detection and response systems), and orchestrate incident response workflows. This allows analysts to focus on higher-level tasks and respond to threats more quickly.",
      "examTip": "SOAR is about improving the speed and effectiveness of security operations by automating and coordinating tasks."
    },
    {
      "id": 49,
