  ...
  "questions": [
    ...
    },
    {
        ...
        "explanation": "Watering hole attacks are *indirect*, targeting a website the victims are likely to visit, rather than attacking the victims directly. It's like poisoning a watering hole that animals (the targets) frequent.",
         "examTip":"Watering hole attacks can be difficult to detect, as they often involve legitimate websites."
    },
    {
        "id": 33,
         "question": "What is the purpose of 'data minimization' in data privacy?",
    ...
    },
    {
    ...
    },
     {
        ...
        "question": "What is 'security orchestration, automation, and response' (SOAR)?",
         "options":[
           "A method for encrypting data.",
            "A set of technologies that enable organizations to automate and streamline security operations, including incident response, threat intelligence, and vulnerability management.",
            "A type of firewall.",
             "A technique for creating strong passwords."
        ],
         "correctAnswerIndex": 1,
       ...
       "question": "What is 'cryptographic agility'?",
        "options":[
          "The ability to quickly crack encrypted data.",
           "The ability of a system or protocol to quickly and easily switch between different cryptographic algorithms or parameters without disrupting operations.",
          "The use of very long encryption keys.",
          "The process of backing up encryption keys."
        ],
       "correctAnswerIndex": 1,
       "explanation": "Cryptographic agility is important for adapting to new threats and vulnerabilities, allowing organizations to upgrade to stronger algorithms or key lengths as needed without major system overhauls.",
        "examTip": "Cryptographic agility is becoming increasingly important as quantum computing and other advancements threaten existing cryptographic algorithms."
    },
     {
       "id": 66,
        "question":"What is 'threat hunting'?",
        "options":[
           "A reactive process of responding to security alerts.",
           "A proactive approach to searching for signs of malicious activity within a network or system that may have bypassed existing security controls.",
           "A type of vulnerability scan.",
            "A method for training employees on security awareness."
       ],
        "correctAnswerIndex": 1,
        "explanation": "Threat hunting goes *beyond* relying on automated alerts. It involves actively searching for indicators of compromise (IOCs) and anomalies that might indicate a hidden threat.",
    ...
    },
    {
       ...
       "options":[
        ...
        "correctAnswerIndex": 1,
        "explanation": "SOAR platforms help security teams work more efficiently by automating repetitive tasks, integrating different security tools, and coordinating incident response workflows. They *combine* orchestration (connecting tools), automation (performing tasks automatically), and response (taking action).",
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation": "File upload functionality is a common attack vector. Attackers can upload malicious files (e.g., containing malware, scripts) that, if executed on the server, can compromise the system. DoS attacks availability; MitM intercepts communications; brute force targets passwords. While those *could* be relevant, the *direct* vulnerability with file uploads is malware.",
