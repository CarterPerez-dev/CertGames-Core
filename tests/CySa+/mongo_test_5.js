  ...
  "questions": [
    {
      ...
      "explanation":
        "`ps aux` shows running processes. `top` displays dynamic real-time view of running processes. `lsof -i` lists open files, including network connections but is less direct for this specific need. `netstat -ano` (or `netstat -tulnp` on some systems) is the most direct command to show *all* network connections (established, listening, etc.), including the owning process ID (PID) which helps link connections to specific applications.",
    ...
    "id": 7,
     "question": "Which type of malware is characterized by its ability to self-replicate and spread across networks without requiring a host file?",
       ...
       "correctAnswerIndex": 1,
       "explanation":
           "Viruses need a host file to spread. Trojans disguise themselves as legitimate software. Rootkits provide hidden, privileged access. A *worm* is a standalone malware program that can *replicate itself* and spread *independently* across networks, exploiting vulnerabilities to infect other systems. It doesn't need to attach to an existing file.",
...
},
{
    ...
    "correctAnswerIndex": 1,
    "explanation":
     "Non-repudiation isn't encryption, backup, or secure deletion. Non-repudiation provides *proof* or *assurance* that a particular user performed a particular action, and that they *cannot* later deny having done it. This is often achieved through digital signatures, audit logs, and other mechanisms that create a verifiable trail of activity.",
...
},
{
  ...
  "question": "Which of the following is a common technique used by attackers to escalate privileges on a compromised system?",
    ...
    "correctAnswerIndex": 1,
  "explanation":
       "Installing firewalls and patching are *defensive* measures. Encryption might be used, but it doesn't directly grant higher privileges. Privilege escalation is the process of an attacker gaining *higher-level access* (e.g., administrator or root privileges) than they initially had. This is typically achieved by exploiting vulnerabilities in software or taking advantage of misconfigured system settings.",
...
},
{
   "id": 15,
    "question": "You are investigating a potential data breach. Which of the following should be your HIGHEST priority?",
     ...
     "correctAnswerIndex": 1,
    "explanation":
   "Identifying the vulnerability, notifying law enforcement (may be required, but not *highest* priority), and restoring systems are all important, but *preserving evidence* is paramount. If evidence is mishandled or the chain of custody is broken, it may become inadmissible in court, hindering the investigation and any potential legal action. This is the foundation of any investigation.",
...
},
{
    ...
    "question":"What is the primary purpose of a 'honeypot' in a network security context?",
     ...
     "correctAnswerIndex": 1,
     "explanation":
        "Honeypots are not for secure data storage, backup connections, or log aggregation. A honeypot is a *deliberately vulnerable* system or network designed to *attract* attackers. This allows security professionals to observe their techniques, gather threat intelligence, and potentially divert them from targeting real, critical systems.",
...
},
{
 ...
 "question": "Which of the following is the MOST effective way to prevent SQL injection attacks?",
   "options":[
    "Using strong passwords for all database user accounts.",
   ...
   "correctAnswerIndex": 1,
  "explanation":
    "Strong passwords help, but don't directly prevent SQL injection. Encryption protects *stored* data, not the injection itself. Penetration testing helps *identify*, not prevent. *Parameterized queries* (prepared statements) treat user input as *data*, not executable code, preventing attackers from injecting malicious SQL. *Input validation* adds another layer by strictly checking the format and type of data entered.",
...
},
{
  "id": 19,
   "question":"What is 'Wireshark' primarily used for?",
    ...
    "correctAnswerIndex": 1,
    "explanation":
    "Wireshark is not a firewall manager, vulnerability scanner, or encryption tool. Wireshark is a powerful and widely used *packet capture* and analysis tool. It allows you to capture network traffic in real-time or load a capture file, and then *inspect individual packets* to analyze protocols, troubleshoot network problems, and detect suspicious activity. It's an essential tool for network and security professionals.",
     "examTip": "Wireshark is the go-to tool for network traffic analysis."
},
{
   "id": 20,
...
},
{
   ...
   "correctAnswerIndex": 1,
   "explanation": "Strong passwords are important generally, but not *directly* for XSS. HTTPS protects data *in transit*. Penetration testing helps *identify* vulnerabilities. The most effective defense against XSS is a combination of *input validation* (thoroughly checking all user-supplied data to ensure it conforms to expected formats and doesn't contain malicious code) and *output encoding* (converting special characters into their HTML entity equivalents, so they are displayed as text and not interpreted as code by the browser).",
...
},
{
   ...
   "correctAnswerIndex": 1,
   "explanation":
    "A security audit is not malware, a database program, or a network cable. A security audit is a formal, independent, and in-depth *assessment* of an organization's security controls, policies, procedures, and practices. Its goal is to identify weaknesses, verify compliance with regulations and standards, and recommend improvements to the overall security posture.",
...
},
{
 ...
 "question":"What is the primary purpose of a 'Security Operations Center (SOC)'?",
  "options":[
    ...
    "To monitor, detect, analyze, respond to, and often prevent cybersecurity incidents.",
     "To conduct only ethical hacking and penetration testing exercises.",
   "To manage the organization's overall IT budget and resources."
  ],
    "correctAnswerIndex": 1,
 "explanation":
    "While SOCs may use custom tools, development is not their primary role. Penetration testing is *part* of security assessments, but not the sole focus. IT budget management is a separate function. The SOC is the central team (or function) responsible for *proactively and reactively* addressing an organization's cybersecurity needs. This includes 24/7 monitoring, threat detection, incident analysis, response, and often preventative measures. They are the defenders of the organization's digital assets.",
...
},
{
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation":
          "You *never* modify original evidence. Sharing it widely compromises integrity. Deleting evidence destroys it. Maintaining a meticulous *chain of custody* (a detailed record of *who* had access to the evidence, *when*, *where*, and *why*) is *absolutely crucial*.  This ensures the evidence is admissible in court and demonstrates that it hasn't been tampered with.",
    ...
    },
{
 ...
 "question": "Which of the following BEST describes 'defense in depth'?",
  ...
  "correctAnswerIndex": 1,
 "explanation":
    "A single firewall is a single point of failure. Encryption and strong passwords are *important components*, but not the complete definition. Defense in depth is a security strategy that involves implementing *multiple, layered* security controls (firewalls, intrusion detection/prevention systems, access controls, encryption, security awareness training, etc.).  If one control fails, others are in place to mitigate the risk.",
...
},
{
 ...
 "correctAnswerIndex": 1,
 "explanation":
  "Log analysis is not primarily about encryption, deletion, or backup (though those *can* be related). Log analysis is *crucial* for incident response. By examining log files (from servers, network devices, applications, etc.), security analysts can reconstruct the timeline of an attack, identify the attacker's methods, determine the scope of the compromise, and gather evidence for investigation and potential legal action.",
...
},
{
 ...
 "correctAnswerIndex": 2,
 "explanation":
  "Phishing uses deception. MitM intercepts communications. XSS injects scripts into websites. A *brute-force attack* is a trial-and-error method used to obtain information such as a user password or personal identification number (PIN). In a brute-force attack, automated software is used to generate a large number of consecutive guesses as to the value of the desired data.",
  "examTip":"Brute Force attacks are mitigated with strong passwords"
},
{
    "id": 44,
...
},
{
 ...
 "correctAnswerIndex": 1,
  "explanation":
   "DR cannot prevent *all* disasters. Encryption and training are important, but not the *primary* goal of DR. Disaster recovery (DR) is a *subset* of business continuity planning (BCP). It focuses specifically on the *IT aspects* of recovery – restoring data, systems, applications, and IT infrastructure to a functional state after a disruptive event (natural disaster, cyberattack, hardware failure, etc.).",
...
},
{
    ...
    "correctAnswerIndex": 1,
    "explanation":
       "Data exfiltration is not backup, encryption, or secure deletion. Data exfiltration is the *theft* of data. It's the unauthorized copying or transfer of data from a compromised system or network to a location under the attacker's control. This is a major goal of many cyberattacks, and a significant data breach risk.",
...
},
{
  ...
  "question": "Which of the following is a common technique used by attackers for 'privilege escalation'?",
   ...
   "correctAnswerIndex": 1,
 "explanation":
 "Installing firewalls and patching are *defensive* actions. Encryption could be used by attackers (e.g., ransomware), but it doesn't inherently grant higher privileges. Privilege escalation involves an attacker gaining *higher-level access rights* (e.g., administrator or root) than they initially had on a compromised system. This is often done by exploiting vulnerabilities in software or taking advantage of misconfigured system settings.",
  "examTip": "Privilege escalation allows attackers to gain greater control over a compromised system."
},
{
  "id": 58,
 ...
 "options":[
  ...
  "To provide secure remote access to internal network resources.",
  "To manage user accounts and access permissions for web applications."
 ],
 "correctAnswerIndex": 1,
  "explanation":
  "WAFs don't handle *all* network encryption, provide general remote access, or manage user accounts. A WAF sits *in front of* web applications and acts as a reverse proxy, inspecting incoming and outgoing HTTP/HTTPS traffic. It uses rules, signatures, and anomaly detection to identify and *block* malicious requests, such as SQL injection, cross-site scripting (XSS), and other web-based attacks, protecting the application from exploitation.",
   "examTip": "A WAF is a specialized firewall specifically designed to protect web applications."
},
{
 "id": 59,
 ...
 "options":[
  ...
  "correctAnswerIndex": 1,
 "explanation":
    "`ls -l` *lists* file permissions (and other details). `chown` changes file *ownership*. `grep` searches for text within files. The `chmod` command (change mode) is used to modify the *permissions* of files and directories on Linux/Unix systems. It controls who can read, write, and execute files.",
...
},
{
    ...
    "options":[
     ...
     "correctAnswerIndex": 1,
   "explanation":
       "DLP may use encryption, but it's not the main goal. It's not primarily for backup or malware removal (though those can be related). DLP systems are designed to *detect* and *prevent* sensitive data (PII, financial data, intellectual property) from being leaked or exfiltrated from an organization's control, whether intentionally or accidentally. This is done by monitoring data in use, in motion, and at rest.",
...
},
{
    ...
    "question": "What is 'threat hunting'?",
     "options":[
     "The process of automatically patching security vulnerabilities.",
        "The proactive and iterative search for evidence of malicious activity within a network or system.",
       "The process of creating strong, unique passwords for all user accounts.",
         "The implementation of a firewall to block unauthorized network traffic."
     ],
   "correctAnswerIndex": 1,
  "explanation": "Threat hunting is not automated patching, password creation, or firewall implementation. Threat hunting is a *proactive* security practice that goes *beyond* relying solely on automated alerts.  It involves *actively searching* for evidence of malicious activity that may have bypassed existing security controls. Threat hunters use a combination of tools, techniques, and their own expertise to identify and investigate potential threats.",
...
},
{
     ...
     "correctAnswerIndex": 1,
     "explanation":
      "Buffer overflows are *technical* exploits. Flooding is DoS. Port scanning is reconnaissance. Social engineering relies on *psychological manipulation*, not technical exploits. Attackers often *impersonate* trusted entities (IT support, a bank, a colleague, etc.) to trick victims into revealing confidential information, clicking malicious links, or opening infected attachments.",
...
},
{
 ...
 "Ensuring that an organization's critical business functions can continue to operate during and after a disruption.",
   ...
   "correctAnswerIndex": 1,
  "explanation":
    "Encryption, strong passwords, and penetration testing are *important security practices*, but not the *core* of BCP. Business continuity planning (BCP) is a comprehensive and proactive process focused on *organizational resilience*.  It aims to ensure that an organization can continue its *essential operations* (or resume them quickly) in the event of a disruption, such as a natural disaster, cyberattack, power outage, or other major incident. It involves identifying critical functions, developing recovery strategies, and testing those strategies.",
...
},
{
 ...
 "correctAnswerIndex": 1,
 "explanation":
    "DR cannot prevent *all* disasters. Encryption and training are important, but not the *definition* of DR. A disaster recovery plan (DRP) is a documented process or set of procedures to recover and protect a business IT infrastructure in the event of a disaster.  It's a *subset* of business continuity planning and focuses specifically on the *IT aspects* of recovery.",
...
},
{
   ...
   "options":[
    ...
    "correctAnswerIndex": 1,
    "explanation":
     "Granting administrator access to all is a major security risk. Using the same password is insecure. Encryption is important, but not the definition. The principle of least privilege is a fundamental security concept. It dictates that users (and processes) should be granted *only* the *minimum necessary* access rights (permissions) required to perform their legitimate tasks. This minimizes the potential damage from compromised accounts, insider threats, or malware.",
...
{
    "id": 74,
    "question": "Which of the following is the MOST effective method for detecting and preventing unknown malware (zero-day exploits)?",
    "options": [
      "Relying solely on signature-based antivirus software.",
        "Using behavior-based detection and anomaly detection techniques.",
       "Conducting regular vulnerability scans.",
        "Implementing strong password policies."
        ],
    "correctAnswerIndex": 1,
    "explanation":
      "Signature-based antivirus is *ineffective* against *unknown* malware. Vulnerability scans identify *known* vulnerabilities. Strong passwords help, but don't directly detect malware. *Behavior-based detection* (monitoring how programs act) and *anomaly detection* (identifying deviations from normal system behavior) are the *most effective* methods for detecting *unknown* malware, including zero-day exploits. These techniques don't rely on pre-existing signatures.",
    "examTip": "Behavior-based and anomaly detection are crucial for defending against unknown threats."
},
{
    "id": 75,
...
},
{
  ...
  "correctAnswerIndex": 1,
  "explanation":
    "Threat hunting is not automated patching, policy implementation, or encryption. Threat hunting is a *proactive* security practice that goes *beyond* relying solely on automated alerts from security tools (like IDS/IPS or SIEM).  Threat hunters *actively search* for evidence of malicious activity that may have bypassed existing defenses. They use a combination of tools, techniques, and their own expertise to identify and investigate subtle indicators of compromise.",
    "examTip":"Threat hunting is a proactive search for hidden threats."
},
{
    "id": 78,
...
{
    "id": 81,
   "question": "Which of the following is the MOST important reason for conducting regular vulnerability scans?",
 "options":[
   "To automatically fix all identified security vulnerabilities.",
   "To identify and prioritize security weaknesses before they can be exploited by attackers.",
   "To encrypt all data stored on a company's servers.",
    "To train employees on how to recognize phishing emails."
   ],
   "correctAnswerIndex": 1,
 "explanation":
    "Vulnerability scans *identify* vulnerabilities, but don't *automatically fix* them (that's remediation). Encryption and training are separate security measures. The primary purpose of regular vulnerability scanning is to *proactively identify* security weaknesses (vulnerabilities and misconfigurations) in systems, networks, and applications *before* attackers can exploit them. This allows organizations to prioritize remediation efforts and reduce their attack surface.",
    "examTip": "Regular vulnerability scans are a crucial part of proactive security."
},
{
     "id": 82,
...
},
{
    ...
    "correctAnswerIndex": 1,
     "explanation":
       "Routine updates usually happen at scheduled times, and wouldn't cause *sustained* high utilization. Hardware malfunctions *can* cause high CPU, but the combination with *high network activity* is more suspicious. Legitimate remote access would likely have a known purpose and user.  Sudden, unexplained high CPU *and* network activity on an idle server strongly suggests a compromise. The server might be infected with malware (e.g., a bot, a cryptominer), or being used for other malicious purposes.",
...
{
        "id": 86,
       "question": "What is 'Nmap' MOST commonly used for?",
       "options":[
       "Encrypting files and folders on a local system.",
        "Scanning networks to discover hosts, open ports, and running services.",
         "Analyzing malware samples in a sandbox environment.",
          "Managing user accounts and access permissions on a server."
      ],
       "correctAnswerIndex": 1,
      "explanation":
     "Nmap is not primarily for file encryption, malware analysis (though it can provide *input* to that), or user management. Nmap is a powerful and versatile *network scanning* and *discovery* tool. It's used to identify active hosts on a network, determine which ports are open, identify the operating systems and services running on those hosts, and even detect some vulnerabilities. It's a fundamental tool for network reconnaissance and security assessments.",
    "examTip": "Nmap is the go-to tool for network scanning and port discovery."
},
{
  "id": 87,
   "question":"What is the primary purpose of 'file integrity monitoring (FIM)'?",
    "options":[
   "To encrypt sensitive data stored on a file server.",
  "To detect unauthorized changes to critical system files and configurations.",
   "To automatically back up all files to a remote server.",
  "To scan files for viruses and other malware."
 ],
   "correctAnswerIndex": 1,
   "explanation":
 "FIM is not primarily for encryption, backup, or virus scanning (though it can integrate with such tools). FIM software monitors important files (system files, configuration files, application files) and alerts administrators to any *unexpected changes*. This helps detect unauthorized modifications that could indicate a malware infection, a system compromise, or a configuration error.",
...
},
{
    ...
    "options":[
        "To store backup copies of critical data in a secure location.",
       "To act as a decoy system, attracting attackers and allowing security teams to study their methods.",
       "To provide a secure, encrypted connection for remote access to a network.",
        "To automatically detect and remove malware from infected systems."
     ],
      "correctAnswerIndex": 1,
     "explanation":
         "Honeypots are not for data backup, secure remote access, or malware removal. A honeypot is a *deliberately vulnerable* system or network designed to *attract* attackers and *mimic* real systems. This allows security professionals to observe attacker behavior, gather threat intelligence, learn about new attack techniques, and potentially divert attackers from real, critical targets.",
     "examTip": "Honeypots are traps used to learn about and distract attackers."
},
{
    "id": 92,
...
},
{
 ...
 "correctAnswerIndex": 1,
 "explanation":
 "Purchasing tools, conducting pen tests, and notifying law enforcement are *later* steps or may not be required. The *very first* step is to *define the plan itself*: its *scope* (what systems and data are covered), *objectives* (what the plan aims to achieve), and *roles and responsibilities* (who is responsible for what during an incident). This provides the foundation for all subsequent planning activities.",
...
},
{
   ...
   "correctAnswerIndex": 1,
     "explanation":
         "Data theft is a different type of attack. Password guessing is brute-force. Injecting scripts is XSS. A DDoS attack aims to disrupt service availability. It uses *multiple compromised systems* (often a botnet) to flood a target (website, server, network) with traffic, overwhelming its resources and making it unable to respond to legitimate requests.",
