  ...
  "questions": [
    {
      ...
      "explanation":
        "Granting administrator access to all is a major security risk.  Equal access for all ignores different job roles. Passwords are still necessary. The principle of least privilege minimizes the potential damage from compromised accounts or insider threats by limiting user access to only what is essential for their job.",
    ...
    },
    {
      ...
      "correctAnswerIndex": 1,
      "explanation":
        "Phishing emails often use generic greetings. While they *may* spoof a trusted sender, they won't *reliably* come from the *legitimate* address. Perfect grammar is not a guarantee of safety.  A sense of urgency or threat, especially related to accounts or finances, is a major red flag for phishing.",
    ...
    },
    {
      ...
      "explanation":
       "Computer model, IP address (in many cases), and OS version are not *directly* identifying. PII (Personally Identifiable Information) is any data that can be used to *uniquely identify* an individual. A Social Security number is a prime example of PII.",
    ...
    },
    {
      ...
      "correctAnswerIndex": 1,
      "explanation":
       "Data exfiltration is not backup, encryption, or secure deletion. Data exfiltration is the *theft* of data. It's when an attacker copies data from a compromised system and sends it to a location they control. This is a primary goal of many cyberattacks.",
    ...
    },
    {
        ...
        "correctAnswerIndex": 2,
        "explanation":
          "Zero-days are *not* long-known or already patched. Unexploitable vulnerabilities are less concerning. A zero-day vulnerability is a *newly discovered* flaw. It's called 'zero-day' because the vendor has had *zero days* to develop a fix. These are highly valuable to attackers because there's no defense against them until a patch is released.",
    ...
    },
    {
      ...
      "correctAnswerIndex": 1,
      "explanation":
       "Data theft, malware installation, and account access are not the *primary* goal (though they *could* be secondary effects). A DDoS (Distributed Denial-of-Service) attack aims to make a service (website, server, etc.) *unavailable* to legitimate users by overwhelming it with traffic from multiple sources.",
    ...
    },
    {
      "id": 12,
       ...
       "correctAnswerIndex": 2,
       "explanation":
        "Eradication, containment, and recovery are later stages. The *first* step is Preparation. This involves establishing policies, procedures, tools, and training *before* an incident occurs, to be ready to handle it effectively.",
    ...
    },
    {
      "id": 13,
       "question": "Which of the following is a common technique used by attackers to maintain access to a compromised system?",
        ...
        "correctAnswerIndex": 1,
        "explanation":
        "Installing a firewall and patching vulnerabilities are *defensive* measures. Encryption might be used by attackers (e.g., ransomware), but not for *maintaining* access. Attackers often create a *backdoor* (a hidden way to access the system) or install a *RAT* (Remote Access Trojan) to maintain persistent access, even if the initial vulnerability is fixed.",
    ...
    },
    {
      ...
      "correctAnswerIndex": 1,
      "explanation":
        "Honeypots are not for secure data storage, backup connections, or encryption. A honeypot is a deliberately vulnerable system or network designed to *attract* attackers.  This allows security professionals to observe their techniques, gather intelligence, and potentially divert them from real targets.",
...
},
{
 ...
 "correctAnswerIndex": 2,
  "explanation":
 "Exploiting vulnerabilities is penetration testing. Automatic fixing is not always possible. Simulating attacks is red teaming. Vulnerability scanning is the process of *identifying* potential security weaknesses (vulnerabilities) in a system, network, or application. It doesn't *exploit* them (that's penetration testing), but it helps prioritize remediation efforts.",
...
},
{
        ...
        "correctAnswerIndex": 2,
        "explanation":
           "FTP and Telnet transmit data in plain text. HTTP is for web traffic, and while HTTPS is secure, it's not primarily for file transfer. SFTP (Secure File Transfer Protocol) uses SSH to provide encrypted file transfer, protecting the confidentiality and integrity of the data.",
...
},
{
        ...
        "correctAnswerIndex": 1,
        "explanation":
          "A single firewall is a single point of failure.  Encryption and antivirus are important, but they are *single* layers. Defense in depth involves using *multiple*, overlapping security controls (e.g., firewalls, intrusion detection, access controls, encryption, etc.) so that if one control fails, others are in place to mitigate the risk.",
    ...
    },
    {
        ...
        "question":"Which term describes the process of verifying a user's identity?",
         ...
         "correctAnswerIndex": 1,
         "explanation":
           "Authorization determines *what* a user can access *after* they're authenticated. Encryption scrambles data. Auditing tracks activity. *Authentication* is the process of verifying that a user is who they claim to be, typically through a username and password, but also through other factors (MFA).",
    ...
    },
{
    ...
    "correctAnswerIndex": 1,
    "explanation":"Strong passwords are important generally, but don't directly prevent SQL injection. Encryption protects data in transit, but not against injection. Vulnerability scans *identify* the vulnerability. Input validation (checking user-provided data) and using *parameterized queries* (treating user input as data, not code) are the *core* defenses against SQL injection. They prevent attackers from injecting malicious SQL code into database queries.",
...
},
{
  ...
  "question": "What is the primary purpose of a 'security policy'?",
   ...
   "correctAnswerIndex": 1,
   "explanation":
     "Security policies are not vulnerability lists or automated patching tools and encryption is a *control*, not the overall *policy*. A security policy is a documented set of rules, procedures, and guidelines that define how an organization manages and protects its information and assets. It outlines acceptable use, security responsibilities, and incident response procedures.",
  ...
  "explanation": "Patch management is not primarily encryption, penetration testing, or user account management. Patch management is the process of systematically applying software updates (patches) released by vendors. These patches often fix security vulnerabilities, bugs, and improve software performance and stability.  A crucial part of vulnerability management.",
   "examTip": "Regular and timely patching is essential for maintaining system security."
},
    {
        ...
        "correctAnswerIndex": 1,
        "explanation":
           "MFA doesn't eliminate passwords; it adds to them. It doesn't improve computer speed or encourage password reuse. MFA adds a *significant* layer of security. Even if an attacker steals a password, they still need the *second* factor (e.g., a code from a phone) to gain access.",
    ...
    },
     {
        ...
        "correctAnswerIndex": 1,
        "explanation":
           "APTs are *not* opportunistic or easily detected. While financial gain *can* be a motive, APTs are often state-sponsored or driven by espionage, targeting specific organizations for strategic reasons. APTs are characterized by their sophistication, persistence (long-term access), and use of advanced techniques to evade detection.",
    ...
    },
    {
        ...
        "correctAnswerIndex": 2,
        "explanation":
          "Incident response isn't password creation, backups, or encryption (though those can be *part* of the process). Incident response is a structured process for handling security incidents (data breaches, malware infections, system compromises, etc.). It involves steps like preparation, detection, analysis, containment, eradication, recovery, and post-incident activity.",
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation":
          "A vulnerability is not a strong password, firewall configuration, or antivirus. A vulnerability is a *weakness* or flaw in a system (software, hardware, configuration) that an attacker *could* exploit to gain unauthorized access, cause damage, or steal data.",
...
},
{
  ...
  "question": "What is a common method for spreading malware?",
   "options":[
    ...
    "correctAnswerIndex": 2,
   "explanation":
 "Strong passwords, software updates, and firewalls are *defenses* against malware. A very common way malware spreads is through *email*. Attackers send emails with malicious attachments (infected files) or links that lead to malware downloads.",
...
},
{
  "id": 43,
    ...
    "correctAnswerIndex": 1,
    "explanation":
       "Sandboxes aren't for long-term data storage, encryption, or VPNs. A sandbox is a *virtualized*, *isolated* environment. It's used to run suspicious files or code *without* risking harm to the host system. This allows analysts to observe the behavior of potentially malicious software safely.",
...
},
{
 ...
 "correctAnswerIndex": 1,
 "explanation":
    "DLP is not primarily backup, encryption (though it might use it), or malware removal. DLP systems are designed to *detect* and *prevent* sensitive data (like PII, financial data, intellectual property) from leaving the organization's control , whether through email, web uploads, removable media, or other channels.",
...
},
{
 ...
 "question": "Which of the following is a common technique used in social engineering attacks?",
  ...
  "correctAnswerIndex": 1,
  "explanation":
   "Exploiting vulnerabilities is a technical attack. Flooding is DoS. Port scanning is reconnaissance. Social engineering relies on *psychological manipulation*, not technical exploits. Attackers often *impersonate* trusted entities (IT support, a bank, a colleague) to trick victims into revealing information or performing actions.",
...
},
{
        ...
        "correctAnswerIndex": 2,
        "explanation":
           "Using default credentials, leaving the network open, and sharing the password widely are all insecure. The best practice is to use a *strong, unique password* for your Wi-Fi network and enable *WPA2 or WPA3 encryption*. This protects your network from unauthorized access.",
    ...
    },
    {
        ...
        "question":"What is 'tailgating' in physical security?",
         ...
         "correctAnswerIndex": 1,
         "explanation":
            "While the term is also used in driving, in *security*, tailgating is a *physical* security breach. It occurs when an unauthorized person follows an authorized person into a restricted area (a building, a room, etc.) without proper credentials or permission.",
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation":
          "Security awareness training isn't about teaching hacking, installing software (though that might be *part* of it), or pen testing. The goal is to *educate* employees about cybersecurity threats (phishing, malware, social engineering, etc.) and to teach them best practices for protecting themselves and the organization's data and systems.",
...
},
{
  ...
  "question": "What is a 'botnet'?",
   "options":[
    ...
    "correctAnswerIndex": 1,
   "explanation":
  "A botnet is not a firewall, spreadsheet software, or cable. A botnet is a network of computers that have been infected with malware (bots) and are controlled remotely by an attacker (the "bot herder").  Botnets are often used for malicious purposes, such as DDoS attacks, sending spam, or stealing data.",
...
},
{
  ...
  "question": "What is the difference between 'symmetric' and 'asymmetric' encryption?",
    ...
    "correctAnswerIndex": 1,
    "explanation":
    "While speed and security *can* vary, that's not the *defining* difference. The location of use (rest/transit) isn't the core distinction. The key difference is the *keys*. Symmetric encryption uses the *same* secret key for both encrypting and decrypting data. Asymmetric encryption uses a *pair* of keys: a public key for encryption and a private key for decryption.",
...
},
{
   "id": 67,
    ...
    "correctAnswerIndex": 1,
    "explanation":"A CA is not a firewall, spreadsheet program or a type of cable. A Certificate Authority (CA) is a trusted organization that issues digital certificates. These certificates are used to verify the identity of websites, servers, and other entities online.  They are essential for establishing trust in secure communication (HTTPS).",
...
},
{
    ...
    "correctAnswerIndex": 1,
     "explanation":
       "Salting is not an encryption algorithm itself, a password generator, or a firewall rule. Salting involves adding a random string (the salt) to a password *before* it's hashed. This makes pre-computed rainbow table attacks (which use pre-calculated hashes of common passwords) much less effective, because the salt changes the resulting hash even if two users have the same password.",
...
},
{
    ...
    "correctAnswerIndex": 1,
    "explanation":
      "No system can prevent *all* attacks. SIEMs are not primarily for encryption or penetration testing. A SIEM system is a core component of a security operations center (SOC). It collects security-related logs from various sources across the network, analyzes them in real-time, correlates events, and generates alerts, providing a comprehensive view of an organization's security posture.",
...
},
{
        ...
        "correctAnswerIndex": 1,
        "explanation":
           "Normal login activity, typical resource usage, and scheduled updates are *not* IoCs. Unusual outbound traffic to an *unknown* IP address is a strong indicator of potential compromise. It could suggest data exfiltration, communication with a command-and-control server, or other malicious activity.",
...
},
{
    ...
    "correctAnswerIndex": 3,
    "explanation":
      "Port 21 is for FTP (insecure). Port 22 is for SSH. Port 80 is for HTTP (insecure). Port 443 is the standard port for HTTPS (secure HTTP) traffic. This is where encrypted communication between a web browser and a web server takes place.",
...
},
{
     "id": 76,
        ...
        "explanation":
            "While a proxy server *can* be used in conjunction with web servers, email servers, or DNS, its *core* function is to act as an intermediary. A client connects to the proxy server, and the proxy server then makes requests to other servers on behalf of the client. This can be used for security, performance, and anonymity.",
...
},
{
  "id": 79,
    ...
    "correctAnswerIndex": 1,
    "explanation":
      "Exploiting software is a *technical* attack. Flooding is DoS. Encryption can be used by attackers, but it's not the *goal* of social engineering. Social engineering relies on *psychological manipulation*, not technical exploits. Attackers aim to deceive users into breaking security procedures or divulging confidential information.",
    "examTip": "Social engineering attacks exploit human trust and psychology."
},
{
 "id": 80,
...
},
{
    ...
    "options":[
     ...
     "correctAnswerIndex": 1,
     "explanation": "Phishing uses social engineering. MitM intercepts communication. SQL injection targets databases. A brute-force attack involves systematically trying many possible passwords (or usernames and passwords) in an attempt to gain unauthorized access. This can be done manually, but is usually automated with specialized tools.",
...
},
{
    ...
    "correctAnswerIndex": 1,
    "explanation":
        "Threat modeling is not physical modeling, attack simulation (that's red teaming), or software development. Threat modeling is a *proactive* process used during system design or development. It involves identifying potential threats, vulnerabilities, and attack vectors, analyzing their likelihood and impact, and prioritizing them to guide security decisions and mitigation efforts.",
...
},
{
   "id": 93,
    ...
    "correctAnswerIndex": 1,
    "explanation":
      "UEBA is not about encryption, patching, or user account management. UEBA uses machine learning and statistical analysis to build a baseline of 'normal' behavior for users and systems. It then detects *deviations* from this baseline, which could indicate insider threats, compromised accounts, or other malicious activity. It focuses on *behavior*, not just known signatures.",
...
},
{
    ...
    "correctAnswerIndex": 1,
    "explanation":
        "Phishing uses deception. MitM intercepts communications. DoS disrupts service. A brute-force attack involves systematically trying every possible combination of characters (letters, numbers, symbols) until the correct password is found. This is usually automated using specialized software.",
