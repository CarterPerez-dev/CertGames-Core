db.tests.insertOne({
  ...
  "questions": [
    ...
    },
    {
        ...
        "correctAnswerIndex": 1, // Best answer - Link-state converges faster
      ...
      },
    {
      ...
      "correctAnswerIndex": 2, // Most targeted next step after ping
      ...
      },
    {
    ...
    },
       {
         "id": 85,
          ...
          "correctAnswerIndex": 2,
          "explanation": "The `show vlan brief` command on a Cisco switch displays a concise summary of VLAN information, including the VLAN ID, name, status, and the *ports assigned to each VLAN*. This is the *most direct* way to verify if switch ports are assigned to the correct VLANs.  `show ip interface brief` shows interface status and IP addresses (Layer 3), `show spanning-tree` shows Spanning Tree Protocol information, and `show mac address-table` shows learned MAC addresses (but not VLAN assignments *directly*).",
          "examTip": "Use `show vlan brief` to quickly check VLAN assignments on Cisco switches."
      },
       {
        "id": 86,
