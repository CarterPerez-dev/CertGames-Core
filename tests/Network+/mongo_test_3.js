  ...
  "questions": [
    ...
    },
    {
    ...
    },
      {
        ...
        "correctAnswerIndex": 1, // While VPN *can* unblock websites, the BEST answer focuses on primary function
    ...
    },
    {
      ...
      "id": 49,
       ...
       {
                "correctAnswerIndex": 1,
        "explanation": "Crosstalk is the electromagnetic interference between adjacent wires within a cable, which can degrade signal quality and cause data errors. Bending is physical damage, signal loss is attenuation, and incorrect connectors are termination issues.",
    ...
    },
    {
      ...
      "options":[
        ...
        "To show the path that packets take to reach a destination, including each hop (router) along the way.",
        "To configure a network interface."
      ],
      "correctAnswerIndex": 2,
      "explanation": "`traceroute` (or `tracert` on Windows) is a diagnostic tool that shows the route taken by packets to a destination host, listing each router (hop) along the path and the time it takes to reach each hop. This helps identify network bottlenecks or routing problems. It doesn't test overall *speed*, display website IPs (that's `nslookup`), or configure interfaces.",
      "examTip": "Use `traceroute` to troubleshoot network connectivity and identify points of latency or failure."
    },
     {
      "id": 52,
      ...
      "correctAnswerIndex": 1,
      "explanation": "Cloud services offer scalability (easily adjust resources), flexibility, and often cost savings compared to managing your own infrastructure. You *don't* have control over the *physical* hardware, security is a *shared* responsibility, and 100% uptime is rarely guaranteed (though high availability is offered).",
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation":"A broadcast storm occurs when a network is overwhelmed by broadcast traffic, often caused by network loops or malfunctioning devices. This can consume all available bandwidth and bring the network to a standstill. It's an *effect*, not a specific *attack* type, and while a DHCP server *could* contribute, it's not the primary cause.",
    ...
    "correctAnswerIndex": 1,
    "explanation": "Full-duplex allows devices to send and receive data at the same time, eliminating collisions and improving network efficiency. Half-duplex allows communication in only one direction at a time. Speed and collision susceptibility are separate characteristics.",
      ...
      },
      {
         "id": 79,
          "question": "Which of the following is an example of network documentation?",
           ...
           "examTip": "Good network documentation is crucial for effective network management."
      },
       {
       "id": 80,
       ...
       },
       {
        ...
        "correctAnswerIndex": 1,
        "explanation": "A duplex mismatch occurs when two connected devices are configured for different duplex settings (half-duplex or full-duplex). This causes collisions and significantly degrades network performance. No connectivity is often a *cable* issue, IP address problems are often *DHCP*, and wireless issues are often *interference or configuration*. ",
     ...
     },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation": "In a client-server network, dedicated servers provide resources (like files, printers, email) and manage security, while clients request those resources. This is more scalable and manageable than peer-to-peer, especially for larger organizations. Setup can be *more* complex, and initial costs may be *higher*, but long-term management is generally easier.",
    ...
    },
    {
         "id": 93,
          ...
          "correctAnswerIndex": 1,
          "explanation":"Routers operate at Layer 3 (Network) and forward traffic *between* different networks based on IP addresses. Switches operate primarily at Layer 2 (Data Link) and forward traffic *within* the same network based on MAC addresses. Both can be used in wired networks (though wireless routers exist). DHCP assigns IP addresses; neither device *assigns* MAC addresses (they're hardware-assigned).",
