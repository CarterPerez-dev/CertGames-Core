db.tests.insertOne({
  category: "aplus",
  testId: 7,
  testName: "A+ Practice Test #7 (Challenging)",
  xpPerCorrect: 10,
  questions: [
    {
      id: 1,
    ...
    {
      id: 34,
      question: "Which of the following TCP ports is used by Microsoft Active Directory Global Catalog for secure and encrypted queries over SSL/TLS (GC)?",
      options: [
        "Port 389",
        "Port 636",
        "Port 3268",
    ...
    {
      id: 53,
      question: "Which of the following is a BEST practice for securing user accounts against brute-force attacks on web applications?",
      options: [
        "Using default usernames (e.g., 'admin').",
      ...
      correctAnswerIndex: 2,
      explanation: "CAPTCHA or reCAPTCHA combined with account lockout policies effectively mitigates brute-force attacks by slowing down repeated login attempts.",
      examTip: "Incorporate CAPTCHA and account lockout to defend against automated brute-force login attacks."
    },
    {
      id: 54,
    ...
    },
    {
      ...
      correctAnswerIndex: 2,
      explanation: "Double exposure or reflection issues with the imaging drum can result in a repeating double image effect.",
      examTip: "Check the imaging drum and laser scanner assembly if you observe double images in prints."
    },
    {
      id: 58,
    ...
    },
    {
      ...
      examTip: "For remote administration of the Kerberos KDC, port 749 (kadmin) is used."
    },
    {
      id: 65,
    ...
    {
      id: 74,
      question: "Which of the following TCP ports is used by Microsoft Active Directory Kerberos authentication for initial authentication requests, and is often targeted in Kerberos 'Golden Ticket' attacks?",
      options: [
        "Port 88 (Kerberos)",
        "Port 464 (kpasswd/changepw)",
        "Port 749 (Kerberos v5)",
      ...
      examTip: "Remember that port 88 is critical for Kerberos authentication in Active Directory."
    },
    {
      id: 75,
    ...
    },
    {
      ...
      correctAnswerIndex: 1,
      explanation: "Managing permissions for numerous, short-lived functions in FaaS can be complex, requiring fine-grained access control.",
      examTip: "Expect increased complexity in managing permissions for individual functions in serverless architectures."
    },
    {
      id: 77,
      question: "A laser printer is producing prints with a repeating 'double image' or 'echo' effect, where a faint copy of the image is printed slightly offset from the main image. Which printer component is MOST likely causing this double image issue?",
    ...
    },
    {
      ...
      examTip: "For stadium-scale Wi-Fi, leverage the advanced features of Wi-Fi 6/6E along with robust planning to manage tens of thousands of users."
    },
    {
      id: 81,
