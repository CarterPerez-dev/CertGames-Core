db.tests.insertOne({
  "category": "aplus",
  "testId": 2,
  "testName": "CompTIA A+ Core 1 (1101) A+ Core 1 Practice Test #2 (Very Easy)",
  "xpPerCorrect": 10,
  "questions": [
    {
      "id": 1,
      ...
      "explanation": "Port 80 is the default port for unencrypted web traffic using HTTP. Port 21 is for FTP, Port 23 is for Telnet, and Port 443 is for the secure version, HTTPS. Exam tip: Memorize common port numbers for quick recall on the exam.",
    ...
    {
      "id": 2,
      "question": "Which type of cable is MOST commonly used to connect a computer to a wired network in an office?",
      "options": [
        "Coaxial cable",
        "Fiber optic cable",
        "Ethernet cable",
      ...
      "correctAnswerIndex": 2,
      "explanation": "Ethernet cables, specifically Cat 5e or Cat 6, are the standard for wired network connections in offices due to their balance of speed and cost-effectiveness. Coaxial is older, Fiber is for high-speed backbones, and USB is for peripherals. Exam tip: Focus on Ethernet for typical LAN connections in office environments.",
      "examTip": "Ethernet cables (Cat 5e and Cat 6) are workhorses for office networks. Know their characteristics and common use cases."
    },
    {
      "id": 3,
      ...
      "options": [
        ...
        "Redundant Array of Modules"
      ],
      "correctAnswerIndex": 1,
      "explanation": "RAM stands for Random Access Memory. It's the volatile memory computers use for active data. Readily Available Memory is not a technical term, Rapid Application Module is unrelated, and Redundant Array of Modules is not relevant to memory. Exam tip: Know the full names of common acronyms like RAM, CPU, and HDD.",
      "examTip": "Always remember the full form of acronyms. 'Random Access Memory' is fundamental to understanding computer memory."
    },
    {
      "id": 4,
      "question": "Which of the following is a common type of connector used for computer monitors?",
      "options": [
        "RJ45",
        "USB-C",
        "HDMI",
      ...
      "correctAnswerIndex": 2,
      "explanation": "HDMI (High-Definition Multimedia Interface) is a prevalent connector for modern monitors, carrying both video and audio. RJ45 is for Ethernet, USB-C is versatile but not primarily for monitors (though increasingly used), and RJ11 is for telephone lines. Exam tip: HDMI is the go-to video connector for modern displays and TVs.",
      "examTip": "HDMI is king for modern video connections. Recognize its port and its function of carrying both audio and video."
    },
    {
      "id": 5,
      ...
      "correctAnswerIndex": 1,
      "explanation": "A firewall's main purpose is to prevent unauthorized access to a network by monitoring and controlling incoming and outgoing network traffic based on security rules. It doesn't boost speed, manage cables, or cool components. Exam tip: Firewalls are essential for network perimeter security.",
      "examTip": "Think of a firewall as a security guard for your network, controlling who and what gets in and out."
    },
    {
      "id": 6,
      ...
      "correctAnswerIndex": 2,
      "explanation": "Microsoft Windows is an operating system, managing hardware and software resources. Microsoft Word, Google Chrome, and Adobe Photoshop are applications that run *on* an operating system. Exam tip: Differentiate between operating systems and applications.",
      "examTip": "Operating Systems like Windows, macOS, and Linux are the foundation. Applications run on top of them."
    },
    {
      "id": 7,
      ...
      "options": [
        ...
        "Common Peripheral Unit"
      ],
      "correctAnswerIndex": 0,
      "explanation": "CPU stands for Central Processing Unit, often called the 'brain' of the computer. It performs calculations and executes instructions. The other options are not standard computer terms. Exam tip: CPU is central to computer processing power.",
      "examTip": "The 'Central Processing Unit' is the heart of the computer. Understand its role in processing instructions."
    },
    {
      "id": 8,
      ...
      "correctAnswerIndex": 1,
      "explanation": "Wi-Fi is a type of wireless network, allowing devices to connect without physical cables. Ethernet, Coaxial, and Fiber Optic are wired network technologies. Exam tip: Wi-Fi is synonymous with wireless networking.",
      "examTip": "Wi-Fi is your everyday wireless network. Remember it as the wireless counterpart to Ethernet."
    },
    {
      "id": 9,
      ...
      "options": [
        ...
        "To create documents",
        "To access and view websites",
        "To send emails"
      ],
      "correctAnswerIndex": 2,
      "explanation": "A web browser is used to access and view websites on the internet. File management is done by file explorers, document creation by word processors, and email by email clients. Exam tip: Web browsers are your window to the World Wide Web.",
      "examTip": "Web browsers like Chrome, Firefox, and Edge are your tools to navigate and view websites."
    },
    {
      "id": 10,
      "question": "Which of these is a common storage device in computers?",
      "options": [
        "Monitor",
        "Keyboard",
        "Hard Disk Drive (HDD)",
      ...
      "correctAnswerIndex": 2,
      "explanation": "A Hard Disk Drive (HDD) is a common storage device used to store data persistently in computers. Monitors, keyboards, and mice are input/output devices, not storage devices. Exam tip: HDDs and SSDs are primary storage components in computers.",
      "examTip": "Think of Hard Disk Drives (HDDs) and Solid State Drives (SSDs) as the computer's long-term memory."
    },
    {
      "id": 11,
      ...
      "correctAnswerIndex": 2,
      "explanation": "USB stands for Universal Serial Bus. It's a standard interface for connecting peripherals to a computer. The other options are not the correct expansion. Exam tip: USB is a ubiquitous standard for device connectivity.",
      "examTip": "Universal Serial Bus (USB) is designed to be universal - connecting many types of devices."
    },
    {
      "id": 12,
      ...
      "correctAnswerIndex": 1,
      "explanation": "Managing hardware resources (like CPU, memory, storage) is a core function of an operating system. Playing games, creating spreadsheets, and editing photos are tasks performed by applications. Exam tip: Operating systems are resource managers.",
      "examTip": "The OS is the conductor of the computer's hardware orchestra. It manages all the resources."
    },
    {
      "id": 13,
      "question": "Which of the following is a security protocol used for secure web browsing?",
      "options": [
        "HTTP",
        "FTP",
        "HTTPS",
      ...
      "correctAnswerIndex": 2,
      "explanation": "HTTPS (Hypertext Transfer Protocol Secure) is a security protocol for secure web browsing, encrypting communication. HTTP is unencrypted, FTP is for file transfer, and Telnet is for remote terminal access. Exam tip: Look for 'S' in HTTPS for 'Secure'.",
      "examTip": "HTTPS is HTTP with a security layer. Always prefer HTTPS for secure online transactions and browsing."
    },
    {
      "id": 14,
      ...
      "correctAnswerIndex": 1,
      "explanation": "Antivirus software is designed to protect computers against malware (viruses, worms, etc.). It doesn't speed up browsing, manage emails, or primarily create backups. Exam tip: Antivirus = anti-malware.",
      "examTip": "Antivirus is your digital bodyguard, protecting your system from malicious software."
    },
    {
      "id": 15,
      "question": "Which of these is a common input device for computers?",
      "options": [
        "Printer",
        "Speaker",
        "Monitor",
      ...
      "explanation": "A keyboard is a common input device, used to enter text and commands. Printers and monitors are output devices, and speakers are audio output. Exam tip: Input devices get data *into* the computer.",
      "examTip": "Keyboards and mice are your primary ways to input commands and data into a computer."
    },
    {
      "id": 16,
      ...
      "correctAnswerIndex": 2,
      "explanation": "A router's primary function is to connect multiple networks together, routing data packets between them. Switches connect devices within a local network, access points amplify Wi-Fi, and surge protectors handle power surges. Exam tip: Routers are network traffic directors.",
      "examTip": "Routers are the gateways between networks, like your home network and the internet."
    },
    {
      "id": 17,
      "question": "Which of these is a portable computer?",
      "options": [
        "Desktop computer",
        "Server",
        "Laptop",
      ...
      "correctAnswerIndex": 2,
      "explanation": "A laptop is a portable computer, designed for mobile use. Desktop computers are stationary, servers are for network services, and mainframes are large-scale systems. Exam tip: Laptops = portable computers.",
      "examTip": "Laptops are all about portability. They are designed to be carried around."
    },
    {
      "id": 18,
      ...
      "options": [
        ...
        "Harmful software designed to damage a computer",
        "A type of computer hardware",
        "Software for creating documents"
      ],
      "correctAnswerIndex": 1,
      "explanation": "Malware is harmful software designed to damage or gain unauthorized access to a computer system. It does not improve performance, it's not hardware, and it's not for document creation. Exam tip: Malware = malicious software.",
      "examTip": "Malware is the enemy! It's software designed to harm your computer or steal your information."
    },
    {
      "id": 19,
      ...
      "correctAnswerIndex": 2,
      "explanation": "An inkjet printer is a type of printer, using ink to create physical documents. Scanners are for digitizing documents, projectors for displaying images, and webcams for video input. Exam tip: Inkjet and laser printers are common types.",
      "examTip": "Inkjet and Laser are the two main types of printers you should be familiar with."
    },
    {
      "id": 20,
      ...
      "options": [
        "To send emails",
        "To manage files online",
        "To find information on the internet",
        "To create social media profiles"
      ],
      "correctAnswerIndex": 2,
      "explanation": "A search engine is used to find information on the internet by indexing and searching web content. Email is handled by email clients, file management by cloud services, and social profiles by social media platforms. Exam tip: Search engines = internet information finders.",
      "examTip": "Search engines like Google, Bing, and DuckDuckGo are your tools to find anything on the internet."
    },
    {
      "id": 21,
      ...
      "correctAnswerIndex": 2,
      "explanation": "RAM (Random Access Memory) is a type of computer memory, used for active data storage. CPU is the processor, GPU is for graphics, and PSU is the power supply unit. Exam tip: RAM is the primary memory type for active use.",
      "examTip": "RAM is the working memory of the computer. It's fast and used for currently running programs."
    },
    {
      "id": 22,
      "question": "What is the function of a 'mouse' in computing?",
      "options": [
        "To display images",
        "To input audio",
      ...
      "correctAnswerIndex": 2,
      "explanation": "A mouse is used to control a cursor on the screen, allowing users to interact with a graphical user interface. Monitors display images, microphones input audio, and printers print documents. Exam tip: Mouse = cursor control.",
      "examTip": "The mouse is your hand on the screen. It controls the cursor for interaction."
    },
    {
      "id": 23,
      "question": "Which of the following is a type of file extension commonly associated with documents?",
      "options": [
        ".exe",
        ".jpg",
        ".docx",
      ...
      "correctAnswerIndex": 2,
      "explanation": ".docx is a file extension commonly associated with Microsoft Word documents. .exe is for executable files, .jpg for images, and .mp3 for audio files. Exam tip: .docx, .pdf, .txt are common document file extensions.",
      "examTip": ".docx, .pdf, and .txt are your document file extensions. Recognize them."
    },
    {
      "id": 24,
      "question": "What does 'Wi-Fi' enable you to do?",
      "options": [
      ...
      "correctAnswerIndex": 1,
      "explanation": "Wi-Fi enables you to connect to a wireless network, allowing devices to communicate without cables. Ethernet is for wired networks, printers print, and scanners scan. Exam tip: Wi-Fi = wireless connectivity.",
      "examTip": "Wi-Fi is all about wireless network access. It frees you from cables."
    },
    {
      "id": 25,
    ...
    {
      "id": 53,
      "question": "Which of the following is a type of computer case form factor, often used for smaller PCs?",
      "options": [
        "ATX",
        "Micro-ATX",
        "Full Tower",
    ...
    {
      "id": 81,
      "question": "Which of the following is a type of wired internet connection?",
      "options": [
        "Wi-Fi",
        "Cellular",
        "DSL",
      ...
      "correctAnswerIndex": 2,
      "explanation": "DSL (Digital Subscriber Line) is a type of wired internet connection, using telephone lines. Wi-Fi, Cellular, and Satellite are wireless internet technologies. Exam tip: DSL, Cable, Fiber are wired internet connections.",
    ...
    },
    {
      ...
      "correctAnswerIndex": 1,
      "explanation": "Disk Cleanup in Windows is used to remove temporary files and free up disk space, improving system performance. Device management is by Device Manager, browsing by browsers, and system settings by Control Panel/Settings. Exam tip: Disk Cleanup = free up disk space.",
      "examTip": "Disk Cleanup is your Windows tool to get rid of junk files and free up space on your hard drive."
    },
    {
      "id": 94,
