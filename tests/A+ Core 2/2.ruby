db.tests.insertOne({
  "category": "aplus2",
  "testId": 2,
  "testName": "CompTIA A+ Core 2 (1102) Practice Test #2 (Very Easy)",
  "xpPerCorrect": 10,
  "questions": [
    {
      "id": 1,
    ...
    },
    {
      ...
      "examTip": "When you see a blinking cursor after POST, suspect a missing or corrupted boot sector. Check for valid boot files or run startup repair tools."
    },
    {
      "id": 22,
    ...
    },
    {
      ...
      "options": [
        "Facial recognition with fingerprint identification.",
    ...
    },
    {
      ...
      "examTip": "On-path attacks are a serious threat; secure communications with protocols like HTTPS, SSL/TLS, or VPNs."
    },
    {
      "id": 62,
    ...
    },
    {
      ...
      "examTip": "Always look for 'https://' and a padlock icon in the address bar when entering sensitive information on a website."
    },
    {
      "id": 65,
    ...
    },
    {
      ...
      "examTip": "Ping is your fundamental connectivity check. If ping fails, investigate local network settings or the remote host’s status."
    },
    {
      "id": 68,
    ...
    },
    {
      ...
      "examTip": "Always isolate an infected system to contain the threat, then run updated security scans."
    },
    {
      "id": 73,
      ...
      "examTip": "Worms spread rapidly and automatically, emphasizing the need for strong network defenses."
    },
    {
      "id": 74,
    ...
    },
    {
      ...
      "examTip": "Always err on the side of caution—delete or report suspicious attachments."
    },
    {
      "id": 77,
      ...
      "examTip": "Use 'tracert' after a failed ping to see where packets stop or slow down on the route."
    },
    {
      "id": 78,
      ...
      "examTip": "Stay vigilant to prevent individuals from quietly trailing you into restricted areas."
    },
    {
      "id": 79,
      ...
      "examTip": "Use exFAT or FAT32 on removable drives for compatibility across multiple OS platforms."
    },
    {
      "id": 80,
      ...
      "examTip": "Zero-day exploits are a race against time—vendors and users must patch quickly once discovered."
    },
    {
      "id": 81,
      ...
      "examTip": "Never grant remote access or divulge credentials to unverified callers."
    },
    {
      "id": 82,
      ...
      "examTip": "Use EFS for file-level encryption; BitLocker secures the entire drive."
    },
    {
      "id": 83,
      ...
      "examTip": "Be cautious about using public or untrusted computers; they may have keyloggers."
    },
    {
      "id": 84,
    ...
    },
    {
      ...
      "examTip": "Always be aware of who might be watching when you type passwords in public settings."
    },
    {
      "id": 86,
      ...
      "examTip": "Double-check suspicious emails and never click links or enter data unless you trust the source."
    },
    {
      "id": 87,
      ...
      "examTip": "Implement a robust backup strategy, including offsite or cloud backups, to protect against data loss."
    },
    {
      "id": 88,
      ...
      "examTip": "Use `ipconfig /release` and `ipconfig /renew` to quickly reset dynamic IP configurations."
    },
    {
      "id": 89,
      ...
      "examTip": "Use a screened subnet/DMZ to protect internal resources while allowing external services to remain reachable."
    },
    {
      "id": 90,
      ...
      "examTip": "A reputable password manager simplifies the creation of strong, unique credentials for every account."
    },
    {
      "id": 91,
    ...
    },
    {
      ...
      "examTip": "Use 'pwd' in Linux to confirm your current location in the file system."
    },
    {
      "id": 93,
      ...
      "examTip": "Malware prevention requires layers: up-to-date patches, reputable antivirus, and cautious user behavior."
    },
    {
      "id": 94,
      ...
      "examTip": "Organizations must balance convenience with security risks when adopting BYOD policies."
    },
    {
      "id": 95,
      ...
      "examTip": "Slow performance with constant disk access often points to a failing or badly fragmented HDD."
    },
    {
      "id": 96,
      "question": "Morgan, a digital archivist using a rare robotic microfiche scanner, needs to ensure that only applications signed by their internal corporate certificate can run on a Windows 11 system. Which Windows feature can enforce this requirement by blocking any untrusted software from executing?",
      "options": [
        "BitLocker",
        "Local Security Policy’s ‘Restrict Anonymous Access’ setting",
        "Windows Defender Application Guard",
        "AppLocker"
      ],
      "correctAnswerIndex": 3,
      "explanation": "AppLocker can restrict executables, scripts, Windows Installer files, and DLLs to those signed by a trusted certificate authority. BitLocker encrypts the drive, Windows Defender Application Guard isolates browser sessions, and ‘Restrict Anonymous Access’ deals with sharing/permissions rather than code execution.",
      "examTip": "Use AppLocker to create allow/deny rules based on publisher certificates, file paths, or file hashes for robust application control."
    },
    {
      "id": 97,
