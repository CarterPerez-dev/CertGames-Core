    ...
    },
      {
        ...
        },
        {
        ...
        },
         {
            ...
            "correctAnswerIndex": 2,
            "explanation":"The Windows Registry is a hierarchical database that stores low-level settings for the OS, device drivers, services, and applications. It's not for user files, network connections (those are managed elsewhere), or user access control (though *some* security settings are stored in the registry).",
        ...
        },
		{
            ...
            "correctAnswerIndex": 1,
            "explanation":"If the user can ping their default gateway, they have basic network connectivity. The inability to access websites, while still being able to ping the gateway, strongly points towards a DNS resolution problem. The user's computer is likely unable to translate domain names (like google.com) into IP addresses.",
        ...
        },
        {
            ...
            "correctAnswerIndex": 2,
            "explanation":"An SPF record is a DNS record that lists the mail servers permitted to send email for a specific domain. This helps receiving mail servers verify the sender's authenticity and reduce email spoofing (forging the sender address). It doesn't encrypt emails, directly block spam (though it helps), or digitally sign messages (DKIM does that).",
        ...
        },
        {
            ...
            "examTip":"Use the Services console to manage Windows services; restarting a service can often resolve related problems."
        },
         {
            "id": 32,
        ...
        },
        {
        ...
        },
          {
            ...
            "correctAnswerIndex": 2,
            "explanation": "OS updates are crucial for security (patching vulnerabilities), stability (fixing bugs), and sometimes functionality (adding new features).  They don't inherently improve processing speed (though performance *can* sometimes be improved), free up disk space (though updates *can* sometimes remove obsolete files), or change the desktop appearance (though some updates *might* include cosmetic changes).",
        ...
        },
        {
            ...
            "correctAnswerIndex": 2,
            "explanation": "Both share permissions (controlling network access) *and* NTFS permissions (controlling local and network access) must be configured correctly for a user to access a shared folder. If other users can access it, the server is likely online, and the user's account probably isn't locked out (you mentioned they have correct permissions). A network cable problem would likely prevent *all* network access, not just access to a specific share.",
        ...
        },
        {
            ...
            "correctAnswerIndex": 1,
            "explanation": "Random shutdowns or restarts, particularly when the system is under stress (gaming, video editing, etc.), can indicate a failing power supply that's unable to provide sufficient power. A consistently booting computer, distorted monitor colors, or an unresponsive keyboard are less likely to be caused by a PSU problem.",
        ...
        },
        {
        ...
        },
         {
            ...
            "correctAnswerIndex": 1,
            "explanation": "A firewall acts as a barrier between a trusted network (like your home or office network) and untrusted networks (like the internet), controlling incoming and outgoing traffic based on predefined rules. It doesn't directly protect against viruses (antivirus software does that), encrypt data (VPNs or encryption protocols do that), or speed up connections.",
        ...
        },
        {
            ...
            "correctAnswerIndex": 2,
            "explanation": "`nslookup` is specifically designed for DNS lookups. It allows you to query DNS servers to find the IP address associated with a domain name or, conversely, to find the domain name associated with an IP address. The other options describe different networking commands.",
        ...
        },
        {
            ...
            "correctAnswerIndex": 1,
            "explanation": "Ransomware encrypts files, making them inaccessible, and demands payment (usually in cryptocurrency) for the decryption key. Data theft, pop-ups, and redirection are characteristics of other types of malware.",
            "examTip": "Maintain regular backups and practice safe browsing habits to protect against ransomware; paying the ransom is not guaranteed to restore your files."
        },
         {
            "id": 62,
        ...
        },
		{
            ...
            "correctAnswerIndex": 2,
            "explanation": "E-waste recycling programs handle electronic waste responsibly, preventing environmental damage and often ensuring data destruction. Throwing it away, selling it without wiping, or leaving it out are all irresponsible and potentially risky (data breaches).",
        ...
        },
         {
            ...
            "correctAnswerIndex": 0,
            "explanation":"BYOD (Bring Your Own Device) refers to employees using their personal devices (laptops, smartphones, tablets) for work purposes. The main security concern is managing and securing these devices, which are outside the direct control of the IT department, and protecting sensitive company data on them.",
        ...
        },
        {
            ...
            "correctAnswerIndex": 1,
            "explanation": "An antistatic wrist strap and mat provide a grounded path for static electricity, preventing it from damaging sensitive electronic components. Rubber gloves don't prevent static buildup, working on carpet *increases* static, and keeping the computer plugged in (but switched off) *can* help with grounding, but is less reliable than a wrist strap.",
        ...
        },
        {
           ...
           "examTip": "Use `tasklist` to identify running processes from the command line, helpful for troubleshooting or scripting."
        },
		 {
            "id": 68,
            ...
            "correctAnswerIndex": 1,
            "explanation": "DHCP simplifies network administration by automatically assigning IP addresses, subnet masks, default gateways, and DNS server addresses to devices. It doesn't encrypt traffic (VPNs or encryption protocols do that), resolve domain names (DNS does that), or filter traffic (firewalls do that).",
        ...
        },
        {
           "id":70,
            ...
            "correctAnswerIndex": 0,
            "explanation":"EOL means the vendor has stopped supporting the product. This is a major security risk, as vulnerabilities discovered after the EOL date will not be patched. While EOL software *might* become free or open-source, that's not the defining characteristic. It also doesn't necessarily mean it's unavailable for purchase (though it often is).",
        ...
        },
        {
            ...
            "correctAnswerIndex": 2,
            "explanation": "Credit card information is considered PII (Personally Identifiable Information) and is subject to regulations like PCI DSS (Payment Card Industry Data Security Standard). The other options are not typically considered regulated data.",
            "examTip": "Handle regulated data (PII, PHI, financial data) with extreme care and comply with relevant regulations (GDPR, HIPAA, PCI DSS, etc.)."
        },
        {
            "id":72,
            ...
            "correctAnswerIndex": 2,
           "explanation": "While a DNS issue can *prevent* a website from being accessed by it's domain, if the website is pingable by IP, DNS has already resolved. The user is able to reach the server. If a proxy is *required* and the computer isn't using it, that could prevent access. A bad cable would prevent *any* network",
        ...
        },
        {
          "id": 74,
           ...
           "correctAnswerIndex": 1,
           "explanation":"Backups create copies of data, allowing you to restore it if the original data is lost or damaged. They don't inherently improve performance, free up disk space (though archiving *can*), or encrypt data (though backups *can* be encrypted).",
        ...
        },
         {
            ...
            "correctAnswerIndex": 2, // Could also be a
            "explanation": "Checking the print queue on the user's computer can reveal if print jobs are stuck, paused, or encountering errors. While the IP address, firewall, and cable are *possible* causes, the print queue is a more direct place to look *after* verifying the basics. Also, verify the computer can see the printer with a ping",
        ...
        },
        {
            ...
            "correctAnswerIndex": 2,
            "explanation": "Strong passwords are complex (mix of character types), long (at least 12 characters, ideally longer), and unique (not reused across accounts). Dictionary words, personal information, and reused passwords are all weak and easily compromised.",
        ...
        },
        {
           "id": 77,
            ...
            "examTip": "Enable 2FA (or MFA - Multi-Factor Authentication) whenever possible, especially for important accounts (email, banking, etc.)."
        },
		{
            "id": 78,
        ...
        },
        {
            ...
            "examTip": "Application whitelisting is a strong security control, but it can be more restrictive and require more administrative overhead than blacklisting (blocking known bad applications)."
        },
         {
            "id": 80,
            ...
            "correctAnswerIndex": 1,
            "explanation":"A VPN creates an encrypted tunnel for your internet traffic, protecting it from interception, especially on untrusted networks (like public Wi-Fi). It doesn't inherently speed up connections (it can sometimes even slow them down), block websites (though some VPNs offer this as an additional feature), or filter spam.",
            "examTip": "Use a VPN to secure your internet connection, especially when using public Wi-Fi or accessing sensitive data remotely."
        },
         {
            "id": 81,
            ...
            "correctAnswerIndex": 1,
            "explanation":"Unexplained changes to the system, new files or programs, and unusual network traffic are all red flags that could indicate a malware infection or unauthorized access. Faster performance, normal booting, and responsive peripherals are not typical signs of compromise.",
        ...
        },
        {
            ...
            "correctAnswerIndex": 1,
            "explanation": "`regedit.exe` is the tool used to directly view and edit the Windows Registry, a hierarchical database of system settings. User accounts, network settings, and software installation are managed through other tools.",
        ...
        },
		 {
            ...
            "correctAnswerIndex": 2,
            "explanation":"Worms are self-replicating malware that spread across networks, exploiting vulnerabilities to infect other systems. Viruses require a host file to spread, Trojans disguise themselves as legitimate software, and spyware gathers information secretly.",
            ...
            "correctAnswerIndex": 1,
            "explanation": "High CPU utilization indicates that one or more processes are demanding excessive processing power.  The next step is to identify *which* processes are responsible (using Task Manager's Processes tab) and investigate the cause. Reinstalling the OS is too drastic. Adding RAM addresses memory issues, not CPU bottlenecks. Disk Cleanup frees up disk space.",
        ...
        },
        {
           "id": 85,
            ...
            "correctAnswerIndex": 1,
            "explanation": "`man` (manual) displays the manual page for a command, providing detailed information about its usage, options, and syntax. `help` is often a built-in shell command that provides brief help for shell builtins, `info` provides more detailed documentation (sometimes) than `man`, and `whatis` gives a one-line description.",
            "examTip": "Use the `man` command followed by the command name (e.g., `man ls`) to access detailed documentation for Linux commands."
        },
        {
            "id": 86,
            ...
            "correctAnswerIndex": 1,
            "explanation": "Unique passwords prevent a single compromised password from granting access to multiple accounts.  Strong passwords make them harder to guess or crack.  While compliance with regulations is important, the *primary* reason is security.  Strong passwords don't make them easier to *remember* (you should use a password manager).",
            "examTip": "Never reuse passwords across different accounts; a breach on one site could compromise all your accounts if you do."
        },
        {
            "id":87,
            ...
            "correctAnswerIndex": 1,
            "explanation": "An 'access denied' error usually indicates a permissions problem. You need to check *both* the share permissions (for network access) and the NTFS permissions (for file/folder access) to ensure the user has the required rights. Rebooting, reinstalling drivers, or running a virus scan are less likely to address a permissions issue.",
        ...
        },
         {
            ...
            "correctAnswerIndex": 1,
            "explanation": "A DoS attack aims to disrupt service by flooding a target with traffic or requests, making it unavailable to legitimate users. Data theft is characteristic of data breaches, encryption is ransomware, and tricking users is social engineering.",
            "examTip": "DoS attacks disrupt service availability; DDoS (Distributed Denial-of-Service) attacks use multiple compromised systems to amplify the attack."
        },
        {
            "id": 89,
            ...
            "correctAnswerIndex": 0,
            "explanation":"Security groups simplify permissions management. You assign permissions to the group, and any user account that's a member of that group automatically inherits those permissions. It's more efficient than assigning permissions to individual users. The other options describe different Active Directory concepts.",
            "examTip": "Use security groups to efficiently manage permissions in an Active Directory environment; assign permissions to groups, not individual users."
        },
		{
            "id": 90,
            ...
            "correctAnswerIndex": 2,
            "explanation": "`tracert` (traceroute) shows the path (hops) that packets take to a destination, including the latency at each hop. This helps identify network bottlenecks. `ping` tests basic connectivity, `ipconfig` shows network configuration, and `netstat` shows active connections.",
        ...
        },
        {
           ...
           "correctAnswerIndex": 2,
           "explanation":"Security logs record security-related events (logins, access attempts, policy changes, etc.). Regularly auditing them helps identify potential security incidents and policy violations. They don't directly improve performance, free up space, or back up data.",
        ...
        },
         {
            ...
            "correctAnswerIndex": 1,
            "explanation": "WPS is notoriously vulnerable to brute-force attacks, making it easy for attackers to gain access to your wireless network. It's generally recommended to *disable* WPS entirely. Changing the PIN is not sufficient to mitigate the vulnerabilities.",
        ...
        },
        {
           "id": 93,
            ...
            "correctAnswerIndex": 1,
            "explanation": "A UPS provides temporary battery power to critical equipment (like servers) during power outages. This allows time to save data and shut down systems properly, preventing data corruption and hardware damage. It's not for cooling, filtering traffic, or increasing bandwidth.",
            "examTip": "Use UPS systems for all critical servers and network devices to ensure business continuity in case of power failures."
        },
        {
            "id":94,
            ...
            "correctAnswerIndex": 1,
            "explanation": "`gpupdate /force` forces the computer to immediately reapply all Group Policy settings, overriding the default refresh schedule. This is useful for testing policy changes or ensuring that new policies are applied promptly. The other options describe different functions.",
        ...
        },
        {
            ...
            "correctAnswerIndex": 1,
            "explanation": "This is the classic description of a ransomware attack. Ransomware encrypts files and demands payment for decryption. Spyware gathers information, Trojans disguise themselves as legitimate software, and worms self-replicate.",
        ...
        },
         {
            ...
            "correctAnswerIndex": 2, //Both less and more work
            "explanation":"`less` is a pager that displays file contents one screenful at a time, allowing scrolling (both forward and backward) and searching. `more` is similar but has fewer features (mainly forward scrolling). `cat` displays the entire file at once, and `grep` searches for patterns within files.",
        ...
        },
        {
           ...
           "question": "You need to copy files from one directory to another on a Windows system, preserving all file attributes and security permissions. Which command-line tool is BEST suited for this task?",
            ...
            "correctAnswerIndex": 2,
            "explanation": "`robocopy` (Robust File Copy) is designed for reliable and advanced file copying, including preserving permissions, attributes, timestamps, and even retrying failed copies. `copy` and `xcopy` are simpler, and `move` *moves* files instead of copying them.",
        ...
        },
		 {
            ...
            "correctAnswerIndex": 2,
            "explanation": "Enabling Remote Desktop allows users to connect to and control the computer from another location using RDP. It's not for general internet access, file/printer sharing (though those can be *used* over a Remote Desktop connection), or performance improvement.",
            "examTip": "Enable Remote Desktop only on trusted networks and configure appropriate security settings (strong passwords, network-level authentication) to prevent unauthorized access."
        },
        {
            "id": 100,
            ...
            "correctAnswerIndex": 1,
            "explanation": "The Services console (services.msc) allows you to configure how services start. Setting the startup type to 'Disabled' prevents it from starting automatically, while 'Manual' allows it to be started manually if needed. Deleting the executable is dangerous, renaming in Task Manager doesn't affect startup, and uninstalling the application might be unnecessary.",
            "examTip": "Use the Services console (services.msc) to manage Windows services and control their startup behavior."
        }
  ]
}
