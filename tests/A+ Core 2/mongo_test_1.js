...
Okay, let's create Test #1 (Normal difficulty) with 100 questions, following all the guidelines and focusing on the CompTIA A+ Core 2 (220-1102) exam objectives. I will use a variety of question types, provide explanations for all answer choices, and include an exam tip for each question. I'll present the questions in a format ready for MongoDB insertion, but without the outer db.tests.insertOne() wrapper for brevity. I'll just provide the JSON object for the test itself.

{
  ...
  "questions": [
    ...
    },
    {
      ...
      "Tricking a user into revealing their password by posing as a help desk technician.",
    ...
    },
    {
        ...
        "options": [
            "Faulty RAM",
            "Corrupted boot sector or missing operating system files",
            "Failed video card",
            "Overheating CPU"
        ],
        "correctAnswerIndex": 1,
...
},
{
    ...
    "options": [
        ...
        "Details about a computer's hardware configuration.",
    ...
    },
    {
    ...
    },
     {
      ...
      "options": [
          ...
          "To improve the performance of the hard drive by reorganizing files.",
  ...
  },
  {
      ...
      },
    {
        ...
        "options": [
            ...
            "A network segment that provides public access to servers (e.g., web servers) while protecting the internal network.",
            "A type of firewall."
        ],
        "correctAnswerIndex": 2,
        "explanation": "A DMZ is a separate network segment that hosts publicly accessible servers (like web, email, or FTP servers).  It acts as a buffer zone, preventing direct access to the internal network from the
{
    "id": 50,
    "question": "Which of the following best describes the purpose of a DMZ (Demilitarized Zone) in network security?",
    "options": [
    ...
    "correctAnswerIndex": 2,
    "explanation": "A DMZ is a separate network segment that hosts publicly accessible servers (like web, email, or FTP servers). It acts as a buffer zone, preventing direct access to the internal network from the internet.",
