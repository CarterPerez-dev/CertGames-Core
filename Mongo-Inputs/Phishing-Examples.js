...
[
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544cfc'),
    type: 'email',
    name: 'Subscription Downgrade Confirmation',
    reason: 'Uses domain spotifyaccounts.net instead of legitimate spotify.com email domain and creates urgency.',                                                                                                            
    from: 'billing@spotifyaccounts.net',
    subject: 'Your Spotify subscription has been downgraded',
    body: 'Dear Spotify Customer,\n' +
      '\n' +
      "We're writing to confirm that your Spotify Premium subscription has been downgraded to the Free tier as requested. Your premium benefits will expire on May 1, 2025.\n" +                                              
      '\n' +
      'If you did not authorize this change, please verify your account immediately to reverse this action: https://account-verify.spotifyaccounts.net/restore-premium\n' +                                                   
      '\n' +
      'You have 48 hours to restore your premium benefits before losing your personalized playlists and offline downloads.\n' +                                                                                               
      '\n' +
      'The Spotify Team',
    links: [ 'https://account-verify.spotifyaccounts.net/restore-premium' ],
    date: '2025-04-21',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544cfd'),
    type: 'email',
    name: 'Airline E-Ticket Confirmation',
    reason: 'Contains legitimate airline formatting with specific flight details and official delta.com domain.',                                                                                                             
    from: 'tickets@delta.com',
    subject: 'Your Delta E-Ticket Receipt and Itinerary',
    body: 'Hello Morgan Taylor,\n' +
      '\n' +
      'Thank you for choosing Delta Air Lines. Your reservation is confirmed.\n' +
      '\n' +
      'RESERVATION DETAILS:\n' +
      'Confirmation Code: DXHK7L\n' +
      'Ticket Number: 006-2451987634\n' +
      '\n' +
      'FLIGHT INFORMATION:\n' +
      'Date: June 12, 2025\n' +
      'Delta Air Lines #1827\n' +
      'From: Atlanta (ATL) - Terminal S\n' +
      'To: San Francisco (SFO) - Terminal 2\n' +
      'Departure: 9:15 AM\n' +
      'Arrival: 11:47 AM\n' +
      'Seat: 14C (Economy)\n' +
      '\n' +
      'PASSENGER: Morgan Taylor\n' +
      '\n' +
      'Check in opens 24 hours before your flight at delta.com/check-in or on the Delta mobile app.\n' +
      '\n' +
      'View your complete itinerary: https://www.delta.com/my-trips/confirmation?code=DXHK7L\n' +
      '\n' +
      'Thank you for flying Delta Air Lines.',
    links: [ 'https://www.delta.com/my-trips/confirmation?code=DXHK7L' ],
    date: '2025-04-22',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544cfe'),
    type: 'sms',
    name: 'Money Transfer Confirmation',
    reason: 'Uses legitimate Zelle formatting and sender ID with no suspicious links or urgent requests.',
    from: 'ZELLE',
    message: 'Zelle: Your transfer of $125.00 to Sophia Roberts has been sent. The money should arrive within minutes.',                                                                                                      
    links: [],
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544cff'),
    type: 'sms',
    name: 'Insurance Policy Suspension Alert',
    reason: 'Creates urgency about policy cancellation and uses short URL that masks destination.',
    from: '+1-612-338-4275',
    message: 'GEICO ALERT: Your auto insurance policy is scheduled for cancellation due to incomplete information. Verify details here to prevent lapse in coverage: gei.co/verify-now',                                      
    links: [ 'gei.co/verify-now' ],
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d00'),
    type: 'website',
    name: 'Password Reset Portal',
    reason: "Uses a deceptive domain 'microsofta-account.com' that adds an extra 'a' to the Microsoft name.",
    url: 'https://passwordreset.microsofta-account.com',
    title: 'Reset Your Microsoft Account Password',
    content: "Verify your identity to reset your Microsoft account password. We'll send a verification code to your recovery email or phone.",                                                                                
    formFields: [
      {
        label: 'Email or Phone',
        type: 'text',
  ...
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d01'),
    type: 'website',
    name: 'Shopify Store Checkout',
    reason: 'Uses HTTPS with the legitimate Shopify domain and standard checkout form fields.',
    url: 'https://store.myshopify.com/checkout',
    title: 'Checkout - Mountain Gear Co.',
    content: 'Review your order and enter your shipping and payment information to complete your purchase.',
    formFields: [
      ...
      { label: 'Expiration Date', type: 'text', placeholder: 'MM/YY' },
      { label: 'CVV', type: 'password', placeholder: 'Security code' }
    ],
    submitButton: 'Complete Order',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d02'),
    type: 'app_download',
    name: 'Fake Fitness Tracker with Excessive Permissions',
    reason: 'Requests unnecessary permissions like SMS and device admin privileges for a simple fitness app.',
    app_name: 'FitTracker Pro',
    developer: 'Health Solutions International',
    platform: 'Google Play',
    rating: '4.6 ★★★★★',
    installs: '1M+',
    description: 'Track your daily workouts, count calories, and monitor your fitness progress with our comprehensive health tracker. Set personal goals, join challenges, and share your achievements with friends on social media.',                                                                                                       
    permissions: [
      'Storage',
      'Camera',
      'Location',
    ...
    reviewHighlights: [
      {
        user: 'Olivia P.',
        text: 'Amazing app! Lost 20 pounds with this tracker.',
        rating: 5
      },
      {
        user: 'Marcus T.',
        text: 'Great features but asks for too many permissions.',
        rating: 3
      }
    ],
    downloadUrl: 'https://play.google.com/store/apps/fittrackerpro',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d03'),
    type: 'app_download',
    name: 'Official Starbucks Mobile App',
    reason: 'Published by verified Starbucks Corporation with appropriate permissions and millions of installs.',                                                                                                             
    app_name: 'Starbucks',
    developer: 'Starbucks Coffee Company',
    platform: 'Apple App Store',
    rating: '4.9 ★★★★★',
    installs: '20M+',
    description: 'Pay and earn Stars by scanning your Starbucks Card, order ahead to skip the line, customize your favorites and get them delivered, find stores, music playing in stores, and more.',                        
    permissions: [
      'Location (optional)',
      'Camera (for payment scanning)',
      'Notifications'
    ],
    reviewHighlights: [
      {
        user: 'Tyler R.',
        text: 'The mobile ordering feature saves me so much time every morning!',
        rating: 5
      },
      {
        user: 'Jessica M.',
        text: 'App works well but sometimes has sync issues with rewards.',
        rating: 4
      }
    ],
    downloadUrl: 'https://apps.apple.com/us/app/starbucks/id331177714',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d04'),
    type: 'qr_code',
    name: 'Museum Exhibit Audio Guide QR',
    reason: 'Links to the official museum domain with expected content path for audio tours.',
    title: 'Ancient Egypt Exhibit Audio Guide',
    context: 'Scan to access the audio tour for our Ancient Egypt exhibition on your personal device.',
    url: 'https://www.metmuseum.org/audio-guide/ancient-egypt/2025',
    caption: 'Free audio guide available in 8 languages',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d05'),
    type: 'qr_code',
    name: 'Restaurant Menu QR with Suspicious URL',
    reason: "Uses a domain 'menu-view.site' instead of the restaurant's official website with a tracking parameter.",                                                                                                         
    title: 'View Our Digital Menu',
    context: 'Scan this QR code to view our full menu with prices and daily specials on your device.',
    url: 'https://menu-view.site/prime-steakhouse?track=2947',
    caption: 'Our new spring menu is now available!',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d06'),
    type: 'social_media',
    name: 'Fake Airline Compensation Post',
    reason: 'Claims free travel vouchers with suspicious URL and no verification through official airline channels.',                                                                                                         
    platform: 'Facebook',
    timestamp: '5 hours ago',
    sender: 'American Airlines Customer Service',
    handle: '@aa_customer.service',
    verified: true,
    message: 'ATTENTION ALL PASSENGERS: Due to our recent scheduling system upgrade, American Airlines is offering $250 travel vouchers to all customers who experienced delays or cancellations in the past 6 months. Claim your voucher by verifying your booking reference at the link below. Limited time offer - expires in 48 hours!', 
    link: 'https://aa-travel-vouchers.com/claim-compensation',
    likes: 3872,
    shares: 2461,
    comments: 729,
    isPhishing: true
  ...
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d07'),
    type: 'social_media',
    name: 'CDC Health Advisory Post',
    reason: 'Posted by verified CDC account with link to official cdc.gov domain and appropriate health information.',                                                                                                        
    platform: 'Facebook',
    timestamp: 'Yesterday at 10:45 AM',
    sender: 'CDC',
    handle: '@CDC',
    verified: true,
    message: 'Health Advisory: We are monitoring a rise in influenza cases across the southern states. Early vaccination is recommended, especially for those at higher risk including adults over 65, children under 5, and people with chronic health conditions. Find vaccination locations near you at the link below.',                 
    link: 'https://www.cdc.gov/flu/prevent/vaccine-finder.htm',
    likes: 8726,
    shares: 4513,
    comments: 1287,
    isPhishing: false
  ...
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d08'),
    type: 'job_offer',
    name: 'Remote Transcription Associate Position',
    reason: 'Promises high pay for minimal skill work with personal banking information requirements.',
    position: 'Remote Transcription Associate',
    company: 'Global Business Solutions Ltd.',
    location: 'Remote (Work from Home)',
    salary: '$35-45 per hour',
    description: 'Immediate opening for transcription associates to work remotely. Simple data entry and document processing with minimal training required. Flexible hours with guaranteed weekly payments sent directly to your personal account. Perfect for students, stay-at-home parents, or anyone looking for additional income.',   
    requirements: [
      'Basic typing skills (30+ WPM)',
      'Personal bank account for weekly payments',
      'Valid ID for verification purposes',
      'Reliable internet connection',
      'Available to start immediately with minimal training'
    ],
    applyEmail: 'careers@gbs-transcription.net',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d09'),
    type: 'job_offer',
    name: 'Marketing Coordinator at Well-Known Company',
    reason: 'Contains realistic job requirements and compensation with official company domain.',
    position: 'Marketing Coordinator',
    company: 'REI Co-op',
    location: 'Seattle, WA (Hybrid)',
    salary: '$62,000 - $72,000 per year',
    description: 'REI is seeking a Marketing Coordinator to support our digital marketing initiatives. This position will assist in planning and executing marketing campaigns, analyzing data from digital channels, and collaborating with cross-functional teams to ensure brand consistency across all marketing materials.',            
    requirements: [
    ...
    applyEmail: 'careers@rei.com',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d0a'),
    type: 'tech_support',
    name: 'System Performance Optimization Alert',
    reason: 'Creates false urgency about system issues and requests remote access to fix supposed problems.',
    title: '⚠ System Performance Alert ⚠',
    alertMessage: 'Your computer is running at 29% of optimal performance. Critical system errors have been detected that may compromise your data and hardware.',                                                            
    technicalDetails: 'Diagnostic Results:\n' +
      'System Health: POOR\n' +
      'Disk Errors: 147\n' +
      'Registry Errors: 358\n' +
      'Driver Status: OUTDATED\n' +
      'Virus Protection: VULNERABLE',
    steps: [
      "Click 'Optimize Now' to begin remote diagnostics",
      'Allow our certified technicians to secure your system',
      'Receive a complete system optimization report',
      'Suggested repair time: 45 minutes'
    ],
    contactInfo: 'Technical Support: 1-888-273-9452 (Reference Code: SYS-OPT-2847)',
    actionButton: 'Optimize Now',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d0b'),
    type: 'tech_support',
    name: 'Browser Privacy Settings Update',
    reason: 'Contains appropriate technical information with standard browser update messaging.',
    title: 'Privacy Settings Update Available',
    alertMessage: 'Chrome has updated its privacy settings to give you more control over your data. Review and adjust your settings to match your preferences.',                                                              
    technicalDetails: 'Version: Chrome 124.0.6367.91\n' +
      'Updated Privacy Features:\n' +
      '- Enhanced cookie controls\n' +
      '- Improved site permissions\n' +
      '- New tracking prevention options',
    steps: [
      'Review your current privacy settings',
      'Select your preferred level of protection',
      'Customize individual site permissions if desired',
      'Changes will apply immediately'
    ],
    contactInfo: 'For more information, visit support.google.com/chrome/privacy',
    actionButton: 'Review Settings',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d0c'),
    type: 'document',
    name: 'Court Notice with Macro Requirement',
    reason: 'Requests enabling macros to view a supposed legal document from a suspicious court domain.',
    fileName: 'Legal_Complaint_Filing_05246.docm',
    fileType: 'Microsoft Word Macro-Enabled Document',
    sender: 'notices@court-filings-online.org',
    contentsPreview: 'NOTICE OF LEGAL PROCEEDINGS\n' +
      '\n' +
      'Case Number: CV-2025-05246\n' +
      'Filing Date: April 21, 2025\n' +
      '\n' +
      'This document contains information regarding legal action in which you are named as a defendant. You are required to respond to this complaint within 21 days of receipt.\n' +                                         
      '\n' +
      '[CONTENT PROTECTED]\n' +
      '\n' +
      'This document contains security features. You must enable macros to view the complete legal notice and response instructions.',                                                                                        
    secured: true,
    source: 'Email attachment from notices@court-filings-online.org',
    enableButton: 'Enable Content to View Legal Notice',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d0d'),
    type: 'document',
    name: 'Legitimate Conference Registration PDF',
    reason: 'Standard PDF from a recognized organization with appropriate formatting and no macro requirements.',                                                                                                             
    fileName: 'TechConference2025_Registration.pdf',
    fileType: 'Adobe PDF Document',
    sender: 'registration@techconference.org',
    contentsPreview: 'TECH CONFERENCE 2025\n' +
      'June 15-17, 2025\n' +
      'San Francisco Convention Center\n' +
      '\n' +
      'Registration Confirmation\n' +
      '\n' +
      'Attendee: Jamie Wilson\n' +
      'Registration ID: TC2025-73819\n' +
      'Registration Type: Full Conference Pass\n' +
      'Amount Paid: $899.00\n' +
      '\n' +
      'Included in your registration:\n' +
      '- Access to all keynote sessions and breakout tracks\n' +
      '- Hands-on workshops (pre-registration required)\n' +
      '- Conference meals and refreshments\n' +
      '- Networking reception on June 15\n' +
      '- Conference materials and digital proceedings\n' +
      '\n' +
      'Hotel information and session schedule are attached.',
    secured: false,
    source: 'Email attachment from registration@techconference.org',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d0e'),
    type: 'payment_confirmation',
    name: 'Fake Cloud Service Payment',
    reason: 'Reports a subscription charge from a service that mimics Microsoft but uses a suspicious domain.',
    company: 'Microsoft OneDrive',
    title: 'Payment Confirmation - OneDrive Storage Subscription',
    message: 'Thank you for your purchase of OneDrive Premium Storage Plan. Your subscription has been activated and your payment has been processed successfully.',                                                          
    transactionId: 'OND-2947836-25',
    date: 'April 22, 2025 - 6:15 AM',
    amount: '$129.99 USD (Annual subscription)',
    paymentMethod: 'MasterCard ending in 3845',
    warning: "If you did not authorize this transaction, please click 'Dispute Charge' immediately to secure your account.",                                                                                                  
    url: 'https://onedrive-billing-center.com/transactions/OND-2947836-25',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d0f'),
    type: 'payment_confirmation',
    name: 'Hotel Reservation Confirmation',
    reason: 'Contains specific booking details with official hotel chain domain and standard reservation format.',                                                                                                            
    company: 'Marriott Hotels',
    title: 'Your Reservation Confirmation',
    message: 'Thank you for choosing Marriott Hotels for your upcoming stay. Your reservation has been confirmed and your deposit has been processed.',                                                                       
    transactionId: 'MRES-87629435',
    date: 'April 21, 2025 - 3:42 PM',
    amount: '$247.85 USD (Deposit - 1 night)',
    paymentMethod: 'Visa ending in 6723',
    details: 'Marriott Chicago Downtown\n' +
      'Check-in: May 15, 2025\n' +
      'Check-out: May 18, 2025\n' +
      'Room Type: King Bed, City View\n' +
      'Guests: 2\n' +
      'Reservation Number: 83742619',
    url: 'https://www.marriott.com/reservation-lookup?code=83742619',
    isPhishing: false
  }
]
Type "it" for more
...
[
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d10'),
    type: 'security_alert',
    name: 'Instagram Unusual Login Notification',
    reason: 'Contains specific device information with standard Instagram security messaging.',
    title: 'New Login Alert',
    message: "We noticed a new login to your Instagram account from a device we don't recognize.",
    details: {
      Time: 'April 21, 2025, 8:23 PM',
      Location: 'Seattle, WA',
      Device: 'iPhone 15',
      Browser: 'Instagram iOS App',
      'IP Address': '74.125.23.XX'
    },
    actions: [
      'If this was you, you can ignore this message',
      "If this wasn't you, secure your account by changing your password",
      'Consider enabling two-factor authentication for added security'
    ],
    referenceId: 'IG-SEC-73625819',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d11'),
    type: 'security_alert',
    name: 'Fake Online Storage Security Breach',
    reason: 'Creates urgency about account compromise and links to a suspicious domain mimicking Dropbox.',
    title: 'URGENT: Dropbox Security Breach',
    message: 'We have detected unauthorized access to your Dropbox account from an unrecognized device. Your files may be at risk of deletion or theft.',                                                                     
    details: {
      Date: 'April 22, 2025',
      Time: '2:47 AM (UTC-7)',
      Location: 'Kiev, Ukraine',
      Device: 'Unknown Windows PC',
      'Files Accessed': '38 files viewed, 12 downloaded'
    },
    actions: [
      'Secure your account immediately',
      'Change your password and enable two-factor authentication',
      'Verify which files may have been compromised',
      'Restore account access by confirming your identity'
    ],
    referenceId: 'DBX-SEC-28375961',
    actionButton: 'Secure Account Now',
    url: 'https://dropbox-security-verification.com/account-recovery',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d12'),
    type: 'browser_extension',
    name: 'Shopping Price Comparison Tool',
    reason: 'Requests reasonable permissions relevant to its functionality with positive, balanced reviews.',
    developer: 'SaveSmart Technologies',
    users: '3.2M+',
    rating: '★★★★☆',
    description: 'Compare prices across multiple shopping sites while you browse. Get automatic coupon code testing, price drop alerts, and cashback opportunities at thousands of online retailers.',                        
    permissions: [
      'Read and change data on websites you visit for shopping',
      'Display notifications',
      'Store local data'
    ],
    reviewQuote: 'This extension has saved me hundreds of dollars this year alone. It finds coupons I would never have known about and the price tracking feature is excellent.',                                             
    source: 'Chrome Web Store',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d13'),
    type: 'browser_extension',
    name: 'PDF Converter Pro Extension',
    reason: 'Requests excessive permissions including browsing history and all site data for a simple PDF tool.',                                                                                                             
    developer: 'Document Solutions HQ',
    users: '950K+',
    rating: '★★★★★',
    description: 'Convert any web page or document to PDF with a single click. Save online articles, receipts, and documents in PDF format directly from your browser with advanced formatting options.',                     
    permissions: [
      'Read and change all your data on all websites',
      'Access your browsing history',
      'Access all browser tabs and windows',
      'Download files and manage downloads',
      'Access clipboard content',
      'Run in background'
    ],
    reviewQuote: 'Works perfectly every time. The conversion quality is excellent with all formatting preserved.',                                                                                                            
    source: 'Chrome Web Store',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d14'),
    type: 'event_invitation',
    name: 'Real Estate Investment Seminar',
    reason: 'Uses high-pressure tactics with artificial scarcity and suspiciously high returns promises.',
    title: 'Exclusive Real Estate Wealth Building Seminar',
    organizer: 'Elite Property Investors Group',
    date: 'May 10, 2025',
    time: '9:00 AM - 5:00 PM',
    location: 'Grand Hyatt Hotel',
    address: '123 Central Avenue, Phoenix, AZ 85004',
    description: 'Join our exclusive one-day seminar where our expert investors will reveal how to generate passive income through real estate with zero money down. Learn the secret strategies that have helped our clients build multi-million dollar property portfolios in just 24 months with minimal risk. This proprietary system works in any market condition and requires no previous experience.',                                              
    speakers: [
      {
        name: 'Robert Chambers',
        title: 'Real Estate Mogul & Bestselling Author'
      },
      { name: 'Sarah Williams', title: 'Property Flipping Expert' },
      {
        name: 'Michael Torres',
        title: 'Creative Financing Specialist'
      }
    ],
    price: 'FREE (Value: $1,997) - Limited to first 50 registrants',
    registerText: 'Reserve Your Seat Now (Only 7 seats remaining!)',
    registrationUrl: 'https://elite-property-seminar.com/exclusive-registration',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d15'),
    type: 'event_invitation',
    name: 'Local Library Author Reading',
    reason: 'Contains specific event details with official library domain and reasonable registration process.',
    title: 'Author Reading: Meet Jhumpa Lahiri',
    organizer: 'Seattle Public Library',
    date: 'May 8, 2025',
    time: '7:00 PM - 8:30 PM',
    location: 'Central Library - Microsoft Auditorium',
    address: '1000 Fourth Ave, Seattle, WA 98104',
    description: 'Join us for an evening with Pulitzer Prize-winning author Jhumpa Lahiri as she discusses her latest novel. The event will include a reading, moderated Q&A session, and book signing. Books will be available for purchase from our local partner bookstore.',                                                             
    speakers: [
      {
        name: 'Jhumpa Lahiri',
        title: "Author, 'The Lowland' and 'Interpreter of Maladies'"
      },
      {
        name: 'Michael Roberts',
        title: 'Literary Editor, Seattle Arts Magazine'
      }
    ],
    price: 'Free (Registration required)',
    registerText: 'Register',
    registrationUrl: 'https://www.spl.org/events/author-reading-jhumpa-lahiri',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d16'),
    type: 'survey',
    name: 'Home Depot Purchase Feedback Survey',
    reason: 'Uses official Home Depot domain with standard rewards program and expected feedback questions.',
    title: 'Home Depot Customer Satisfaction Survey',
    sponsoredBy: 'Home Depot Customer Experience Team',
    description: 'Thank you for your recent purchase at Home Depot. We value your feedback and would appreciate if you could take a few minutes to tell us about your shopping experience. Your responses help us improve our products and services.',                                                                                       
    timeRequired: '5 minutes',
    questionCount: '10',
    reward: 'Enter to win a $100 Home Depot gift card (monthly drawing)',
    sampleQuestion: 'How would you rate your overall satisfaction with your recent Home Depot shopping experience?',                                                                                                          
    sampleOptions: [
      'Very Satisfied',
      'Satisfied',
      'Neutral',
    ...
    disclaimer: 'No purchase necessary to enter. One winner selected monthly. See official rules for details.',
    buttonText: 'Begin Survey',
    url: 'https://www.homedepot.com/survey?receipt=HD2947683',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d17'),
    type: 'survey',
    name: 'Phone Carrier Free iPhone Reward Survey',
    reason: 'Offers unrealistic reward (free iPhone) for minimal effort with suspicious third-party domain.',
    title: 'AT&T Customer Appreciation Survey - Win a Free iPhone 15!',
    sponsoredBy: 'AT&T Customer Loyalty Program',
    description: "As a valued AT&T customer, you've been selected to participate in our brief customer appreciation survey. Complete this 2-minute survey and you'll be eligible to receive a free iPhone 15 as part of our customer loyalty program!",                                                                                      
    timeRequired: '2 minutes',
    questionCount: '5',
    reward: 'Brand New iPhone 15 (128GB)',
    sampleQuestion: 'How would you rate the quality of service you receive from AT&T?',
    sampleOptions: [ 'Excellent', 'Good', 'Average', 'Below Average', 'Poor' ],
    disclaimer: 'Limited to first 20 participants today. Requires valid ID and shipping information for prize delivery.',                                                                                                     
    buttonText: 'Start Survey Now',
    url: 'https://att-customer-rewards.com/iphone-giveaway',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d18'),
    type: 'wifi_portal',
    name: 'Hotel Room WiFi Login',
    reason: 'Requests unusual information including date of birth and ID for simple hotel WiFi access.',
    title: 'Hilton Guest WiFi',
    networkName: 'Hilton_Guest',
    message: 'Welcome to Hilton Hotels. Please complete the form below to access our premium high-speed internet during your stay.',                                                                                          
    loginMethod: 'credentials',
    skipPassword: false,
    requiresAgreement: true,
    formFields: [
    ...
    footerText: 'By connecting, you agree to our terms of service and authorize a $14.95 daily charge for premium WiFi access.',                                                                                              
    buttonText: 'Connect Now',
    portalUrl: 'https://hilton-guest-wifi.net/login',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d19'),
    type: 'wifi_portal',
    name: 'Conference Center Attendee WiFi',
    reason: 'Uses appropriate conference domain with standard login credentials for event attendees.',
    title: 'TechConference 2025 WiFi',
    networkName: 'TechConf_2025',
    message: 'Welcome to TechConference 2025. Please enter your conference registration details to access our dedicated attendee WiFi network.',                                                                              
    loginMethod: 'credentials',
    skipPassword: false,
    requiresAgreement: true,
    formFields: [
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'Found on your badge'
      }
    ],
    footerText: 'Complimentary WiFi provided for all registered attendees. Connection valid for the duration of the conference (June 15-17, 2025).',                                                                          
    buttonText: 'Connect',
    portalUrl: 'https://wifi.techconference2025.org/connect',
    isPhishing: false
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d1a'),
    type: 'video_conference',
    name: 'Fake HR Policy Meeting Invitation',
    reason: 'Creates urgency about mandatory attendance and uses a suspicious third-party meeting domain.',
    platform: 'ZoomEx Meeting',
    title: 'MANDATORY: Updated HR Policy Review Session',
    organizer: 'Human Resources Department',
    organizerEmail: 'hr-department@company-corporate.org',
    topic: 'Critical HR Policy Updates - Mandatory Attendance',
    time: 'April 24, 2025, 9:00 AM - 10:00 AM',
    duration: '60 minutes',
    meetingLink: 'https://zoomex-meetings.com/j/937465213?secure=HR73925',
    meetingId: '937 465 213',
    passcode: 'HR2025',
    joinButtonText: 'Join Meeting (Attendance Required)',
    note: 'This meeting is mandatory for all employees. Failure to attend may result in disciplinary action. Please download our secure meeting client before joining.',                                                      
    hostDomain: 'zoomex-meetings.com',
    isPhishing: true
  },
  {
    _id: ObjectId('6807cd8c1d1e9f3fc0544d1b'),
    type: 'file_sharing',
    name: 'Legal Document Retention Notice',
    reason: 'Contains standard company document with appropriate legal notice formatting and genuine company domain.',                                                                                                        
    platform: 'SharePoint',
    title: 'Important Legal Hold Notice - Review Required',
    userName: 'Legal Department',
    userEmail: 'legal@acme-industries.com',
    message: 'As part of our ongoing compliance requirements, we need to ensure all employees are aware of our document retention policies. Please review the attached Legal Hold Notice which affects several departments including yours. This document outlines which materials must be preserved and for how long.',                     
    fileName: 'Legal_Hold_Notice_2025.pdf',
    fileSize: '1.2 MB',
    fileType: 'PDF Document',
    expirationPeriod: 'No expiration',
    buttonText: 'View Document',
    fileUrl: 'https://acme-industries.sharepoint.com/sites/legal/documents/Legal_Hold_Notice_2025.pdf',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544ca7'),
    type: 'email',
    name: 'Password Reset Request from IT Department',
    reason: 'Uses internal company language but comes from an external domain with urgent action requirements',
    from: 'it-support@company-helpdesk.net',
    subject: 'URGENT: Your Company Password Will Expire Today',
    body: 'Dear Valued Employee,\n' +
      '\n' +
      'Our system indicates your company network password will expire in 3 hours. To prevent loss of access to company resources, you must reset your password immediately.\n' +                                              
      '\n' +
      'Click here to reset your password: https://company-password-reset.net/login\n' +
      '\n' +
      'This reset must be completed within the next 3 hours to prevent account lockout.\n' +
      '\n' +
      'Thank you,\n' +
      'IT Support Team',
    links: [ 'https://company-password-reset.net/login' ],
    date: '2025-04-22',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544ca8'),
    type: 'email',
    name: 'Library Book Due Reminder',
    reason: 'Contains expected library language with legitimate domain and standard overdue notification format',                                                                                                             
    from: 'notifications@nypl.org',
    subject: 'Reminder: Library Items Due Soon',
    body: 'Hello Patron,\n' +
      '\n' +
      'This is a courtesy reminder that you have items due soon at the New York Public Library.\n' +
      '\n' +
      'Due April 25, 2025:\n' +
      '- The Midnight Library by Matt Haig\n' +
      '- The Lincoln Highway by Amor Towles\n' +
      '\n' +
      'You can renew eligible items online at www.nypl.org/myaccount or by calling your local branch.\n' +
      '\n' +
      'Thank you for using the New York Public Library.\n' +
      '\n' +
      'NYPL Member Services',
    links: [ 'https://www.nypl.org/myaccount' ],
    date: '2025-04-22',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544ca9'),
    type: 'website',
    name: 'Cloud Storage Login with Domain Typo',
    reason: "Uses 'dropobox.com' instead of legitimate 'dropbox.com' domain with very similar login page layout",                                                                                                             
    url: 'https://www.dropobox.com/login',
    title: 'Sign in to Dropbox',
    content: 'Sign in to access your files and folders stored in Dropbox. Work on documents with your team and share content with clients securely from anywhere.',                                                           
    formFields: [
      { label: 'Email', type: 'email', placeholder: 'Email' },
      { label: 'Password', type: 'password', placeholder: 'Password' }
    ],
  ...
  {
    _id: ObjectId('6807d24deaeafbb720544caa'),
    type: 'website',
    name: 'GitHub Repository Access Page',
    reason: 'Uses legitimate GitHub domain with standard repository access form and security protocols',
    url: 'https://github.com/login?return_to=octocat/Hello-World',
    title: 'Sign in to GitHub',
    content: 'Sign in to GitHub to access octocat/Hello-World repository. Collaborate, review code, manage projects, and build software alongside 100 million developers.',                                                   
    formFields: [
      {
  ...
  {
    _id: ObjectId('6807d24deaeafbb720544cab'),
    type: 'sms',
    name: 'Account Verification Text with Short URL',
    reason: 'Creates false urgency for account verification with masked URL shortener hiding destination',
    from: '+1-503-295-8743',
    message: 'Your ACCOUNT has been temporarily LIMITED due to suspicious login attempts. Verify your identity: vrfy.io/acct-8743',                                                                                           
    links: [ 'vrfy.io/acct-8743' ],
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cac'),
    type: 'sms',
    name: 'Delivery Notification from National Postal Service',
    reason: 'Uses official USPS shortcode with standard delivery notification format and no external links',
    from: 'USPS',
    message: 'USPS: Your package will be delivered today by 5:00PM. For inquiries call 1-800-275-8777 or visit usps.com',                                                                                                     
    links: [],
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cad'),
    type: 'app_download',
    name: 'Screen Recorder Pro with Unnecessary Permissions',
    reason: 'Screen recording app requests disproportionate permissions like contacts and payment info access',
    app_name: 'Screen Recorder Pro HD',
    developer: 'ProMedia Apps',
    platform: 'Google Play',
    rating: '4.6 ★★★★☆',
    installs: '5M+',
    description: 'Easily record your screen in HD quality with our professional screen recorder. Perfect for tutorials, gameplay recording, and video calls. Includes editing tools and instant sharing options.',            
    permissions: [
      'Storage',
      'Microphone',
      'Camera',
    ...
    reviewHighlights: [
      {
        user: 'Nathan P.',
        text: 'Great app but why does it need access to my contacts?',
        rating: 3
      },
      {
        user: 'Olivia M.',
        text: 'Works perfectly for recording my gameplay videos!',
        rating: 5
      }
    ],
    downloadUrl: 'https://play.google.com/store/apps/screenrecorderpro',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cae'),
    type: 'app_download',
    name: 'Official Banking App with Limited Permissions',
    reason: 'Published by verified banking institution with appropriate security permissions for financial app',
    app_name: 'PNC Mobile Banking',
    developer: 'PNC Bank N.A.',
    platform: 'Apple App Store',
    rating: '4.8 ★★★★★',
    installs: '10M+',
    description: 'Manage your PNC accounts securely on the go. Check balances, deposit checks, transfer money, pay bills, and locate branches and ATMs near you.',                                                            
    permissions: [
      'Camera (for mobile check deposit)',
      'Face ID/Touch ID',
      'Location (optional for ATM finder)'
    ],
    reviewHighlights: [
      {
        user: 'Marcus L.',
        text: 'Latest update made the app even more secure and user-friendly.',
        rating: 5
      },
      {
        user: 'Ava S.',
        text: 'Occasional slowness but great functionality overall.',
        rating: 4
      }
    ],
    downloadUrl: 'https://apps.apple.com/us/app/pnc-mobile-banking/id301077500',
    isPhishing: false
  }
]
Type "it" for more
...
[
  {
    _id: ObjectId('6807d24deaeafbb720544caf'),
    type: 'qr_code',
    name: 'Car Rental Discount Code QR',
    reason: 'QR leads to a confusingly similar domain (enter-prize.co) instead of legitimate enterprise.com',
    title: 'Exclusive Rental Car Discount',
    context: 'Scan this QR code to receive 25% off your next Enterprise car rental. Limited time offer!',
    url: 'https://enter-prize.co/special-offer',
    caption: 'Offer expires 05/31/2025. Some restrictions apply.',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb0'),
    type: 'qr_code',
    name: 'Digital Concert Ticket Entry',
    reason: "Links to the venue's official domain with expected ticketing path and event information",
    title: 'Digital Ticket: Bruno Mars Concert',
    context: 'Scan this QR code at the venue entrance for quick admission to the Bruno Mars Residency Las Vegas.',                                                                                                            
    url: 'https://www.parkmgm.com/en/entertainment/bruno-mars/tickets/scan/TK-75346921',
    caption: 'Valid April 30, 2025 at 8:00PM | Park MGM Theater',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb1'),
    type: 'social_media',
    name: 'Product Recall Announcement by Impersonator',
    reason: "Uses unofficial handle '@samsung.product.safety' mimicking official communication with urgent recall",                                                                                                           
    platform: 'Facebook',
    timestamp: 'Yesterday at 2:30 PM',
    sender: 'Samsung Product Safety',
    handle: '@samsung.product.safety',
    verified: true,
    message: "URGENT PRODUCT RECALL: We've identified a critical battery defect in Samsung Galaxy S24 phones manufactured between January-March 2025. These devices may overheat and cause injury. Click below to check if your device is affected and arrange for a free replacement or repair.",                                           
    link: 'https://samsung-device-check.com/recall-program',
    likes: 4736,
    shares: 12895,
    comments: 2341,
    isPhishing: true
  ...
  {
    _id: ObjectId('6807d24deaeafbb720544cb2'),
    type: 'social_media',
    name: 'City Water Service Interruption Notice',
    reason: 'Posted by verified city government account with appropriate municipal information',
    platform: 'Facebook',
    timestamp: '3 hours ago',
    sender: 'City of Portland',
    handle: '@CityofPortland',
    verified: true,
    message: 'WATER SERVICE NOTICE: Crews will be performing maintenance on water mains in the Pearl District on Thursday, April 24, from 10 PM to 4 AM. Residents in the affected area (map in link) may experience low pressure or temporary service interruption. We apologize for any inconvenience.',                                   
    link: 'https://www.portland.gov/water/notification/2025-04-24',
    likes: 342,
    shares: 215,
    comments: 87,
    isPhishing: false
  ...
  {
    _id: ObjectId('6807d24deaeafbb720544cb3'),
    type: 'job_offer',
    name: 'Social Media Evaluator Remote Position',
    reason: 'Offers unrealistic compensation for minimal work and requests financial information during application',                                                                                                         
    position: 'Social Media Content Evaluator',
    company: 'Digital Research Partners',
    location: 'Remote (Work from Home)',
    salary: '$45-60 per hour',
    description: "We're seeking individuals to evaluate social media content for our clients. Work from home on your own schedule viewing and rating posts, videos, and advertisements. No special qualifications required - just basic internet knowledge and attention to detail. Get paid weekly through direct deposit.",                
    requirements: [
      'Access to a smartphone or computer with internet',
      '18+ years of age with valid ID',
      'Bank account for direct payments',
      'Ability to work 10-40 hours weekly (you choose)',
      'No prior experience necessary - training provided'
    ],
    applyEmail: 'jobs@digital-research-partners.co',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb4'),
    type: 'job_offer',
    name: 'Data Scientist Position at Research Institution',
    reason: 'Contains specific technical requirements and reasonable salary range appropriate for the position',
    position: 'Senior Data Scientist',
    company: 'Mayo Clinic',
    location: 'Rochester, MN (Hybrid)',
    salary: '$120,000 - $145,000',
    description: "The Mayo Clinic's Center for Digital Health is seeking an experienced Data Scientist to join our interdisciplinary research team. You will design and implement machine learning models for analyzing healthcare data, collaborate with physicians and researchers, and develop innovative solutions to improve patient outcomes.",                                                                                                       
    requirements: [
      "Ph.D. or Master's degree in Computer Science, Statistics, or related field",
      '5+ years of experience with machine learning and statistical modeling',
      'Proficiency in Python, R, and SQL',
      'Experience with healthcare data and/or clinical research',
      'Strong publication record and communication skills'
    ],
    applyEmail: 'careers@mayoclinic.org',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb5'),
    type: 'tech_support',
    name: 'Windows Defender Virus Alert with Unusual Contact Method',
    reason: 'Creates false urgency with unusual WhatsApp contact method instead of standard Windows support',
    title: '⚠ VIRUS DETECTED - Immediate Action Required ⚠',
    alertMessage: 'Windows Defender has detected multiple high-severity threats that could compromise your personal data and banking information. Your system is at critical risk.',                                          
    technicalDetails: 'Threats detected: Trojan.BitCoinMiner.VBS.221\n' +
      'Affected files: System32, Registry\n' +
      'Risk level: CRITICAL\n' +
      'Infection source: Browser exploit',
    steps: [
      'Do not turn off your computer or close this window',
      'Contact Microsoft Certified Technician via WhatsApp: +1-352-664-0193',
      'Provide error code: MS-DEFENDER-8743',
      'Allow remote assistance to remove threats immediately'
    ],
    contactInfo: 'WhatsApp support: +1-352-664-0193 (24/7 Emergency Support)',
    actionButton: 'Connect to Support',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb6'),
    type: 'tech_support',
    name: 'Firefox Browser Update Notification',
    reason: 'Contains appropriate Mozilla branding with standard update information and no urgent action required',                                                                                                           
    title: 'Firefox Update Available',
    alertMessage: 'A new version of Firefox is available that includes security improvements and new features.',
    technicalDetails: 'Current version: 124.0.1\n' +
      'New version: 125.0\n' +
      'Release type: Standard Update\n' +
      'Size: 76.3 MB',
    steps: [
      'Save your work before updating',
      "Click 'Update Now' to install the new version",
      'Firefox will restart after the update completes',
      'Your open tabs will be restored automatically'
    ],
    contactInfo: 'For more information, visit support.mozilla.org/firefox/updates',
    actionButton: 'Update Now',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb7'),
    type: 'document',
    name: 'Financial Statement with Macro Requirements',
    reason: 'Claims to be from a financial institution but requires enabling macros which is a security risk',
    fileName: 'Tax_Return_Summary_2024.xlsm',
    fileType: 'Microsoft Excel Macro-Enabled Workbook',
    sender: 'documents@tax-filing-center.com',
    contentsPreview: 'TAX RETURN SUMMARY 2024\n' +
      '\n' +
      'Prepared for: [Client Name]\n' +
      'Date: April 15, 2025\n' +
      '\n' +
      'This document contains your completed tax return summary including:\n' +
      '\n' +
      '- Income overview\n' +
      '- Deductions summary\n' +
      '- Refund calculation\n' +
      ...
      '[CONTENT PROTECTED]\n' +
      '\n' +
      "To view your complete tax return information, please click 'Enable Content' when prompted.",
    secured: true,
    source: 'Email attachment from documents@tax-filing-center.com',
    enableButton: 'Enable Content to View Tax Information',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb8'),
    type: 'document',
    name: 'Conference Schedule PDF',
    reason: 'Standard PDF from a recognized organization with legitimate formatting and no macro requirements',
    fileName: 'AI_Conference_Schedule_2025.pdf',
    fileType: 'Adobe PDF Document',
    sender: 'program@neurips.cc',
    contentsPreview: 'NEURIPS 2025 CONFERENCE SCHEDULE\n' +
      '\n' +
      'San Francisco Convention Center\n' +
      'December 7-13, 2025\n' +
      '\n' +
      'Highlights:\n' +
      '\n' +
      '- Keynote Address: Dr. Fei-Fei Li - "The Future of Foundation Models" (Dec 8, 9:00 AM)\n' +
      '- Panel Discussion: "Ethics in AI Development" with Yoshua Bengio, Kate Crawford, and Timnit Gebru (Dec 9, 1:00 PM)\n' +                                                                                               
      '- Workshop: "Reinforcement Learning from Human Feedback" (Dec 10, 10:00 AM)\n' +
      '- Poster Sessions: Hall B, Daily from 3:00-6:00 PM\n' +
      '- Networking Reception: Grand Ballroom, Dec 8, 7:00 PM\n' +
      '\n' +
      'Complete session listings and room assignments are included in the following pages.',
    secured: false,
    source: 'Email attachment from program@neurips.cc',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cb9'),
    type: 'payment_confirmation',
    name: 'Premium Streaming Service Auto-Renewal',
    reason: "Contains subtle domain misspelling 'netflixbilling.com' instead of legitimate Netflix domain",
    company: 'Netflix',
    title: 'Your Netflix subscription payment',
    message: "Thank you for being a Netflix member. We've successfully processed your monthly subscription payment for Netflix Premium (4K UHD, 4 screens).",                                                                 
    transactionId: 'NF-95867312',
    date: 'April 22, 2025 - 12:15 PM',
    amount: '$19.99 USD',
    paymentMethod: 'Visa ending in 4587',
    warning: "If you didn't authorize this charge, please update your payment information immediately: https://billing.netflixbilling.com/manage-payment",                                                                    
    url: 'https://billing.netflixbilling.com/manage-payment',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cba'),
    type: 'payment_confirmation',
    name: 'Annual Website Domain Renewal',
    reason: 'Contains appropriate GoDaddy branding with standard domain renewal information and pricing',
    company: 'GoDaddy',
    title: 'Domain Renewal Confirmation',
    message: 'Thank you for renewing your domain name. Your domain will remain active for another year. Below are the details of your renewal transaction.',                                                                  
    transactionId: 'GOD-73629154',
    date: 'April 20, 2025 - 3:42 PM',
    amount: '$18.99 USD',
    paymentMethod: 'MasterCard ending in 7382',
    details: 'Domain: example.com\n' +
      'Renewal Period: 1 Year\n' +
      'Expiration Date: April 20, 2026\n' +
      'Auto-Renewal: Enabled',
    url: 'https://account.godaddy.com/domain-control',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cbb'),
    type: 'security_alert',
    name: 'Account Access from Unusual Location with Custom Domain',
    reason: 'Creates urgency about account security but links to a non-official domain mimicking Google',
    title: 'Google Security Alert',
    message: 'We detected a new sign-in to your Google Account from an unrecognized device in an unusual location.',                                                                                                          
    details: {
      Time: 'April 22, 2025, 3:17 AM',
      Location: 'Jakarta, Indonesia',
      Device: 'Unknown Android device',
      Browser: 'Chrome Mobile',
      'IP Address': '103.85.97.XX'
    },
    actions: [
      'If this was you, you can safely ignore this message',
      "If this wasn't you, secure your account immediately",
      'Change your password and enable 2-step verification',
      "Review recently used devices and remove any you don't recognize"
    ],
    referenceId: 'CAS-48273-691',
    actionButton: 'Secure Account',
    url: 'https://accounts-google.security-center.com/verify',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cbc'),
    type: 'security_alert',
    name: 'Legitimate Account Recovery Activity Notification',
    reason: 'Contains specific device information with standard Apple security alert formatting',
    title: 'Apple ID Recovery Attempt',
    message: "Your Apple ID password was recently reset. If you didn't make this change, you should recover your account.",                                                                                                   
    details: {
      Date: 'April 22, 2025',
      Time: '10:43 AM EDT',
      Location: 'Chicago, IL',
      Device: 'MacBook Pro (2024)',
      'Apple ID': 'j****n@icloud.com'
    },
    actions: [
      'If you reset your password, you can ignore this message',
      "If you didn't reset your password, visit appleid.apple.com immediately",
      'Check your recovery methods are up to date',
      'Enable two-factor authentication if not already enabled'
    ],
    referenceId: 'APL-IDRC-78392641',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cbd'),
    type: 'advertisement',
    name: 'Miracle Weight Loss Supplement Ad',
    reason: 'Promises unrealistic quick results with artificial scarcity tactics and suspicious domain',
    title: 'MELT 30 LBS IN 30 DAYS - NO DIET OR EXERCISE!',
    description: 'Scientists shocked by new weight loss discovery that helps people lose 1 pound daily without changing their diet or hitting the gym. 100% natural ingredients with no side effects. Limited supply due to high demand.',                                                                                                   
    imageText: 'BEFORE/AFTER RESULTS',
    displayUrl: 'slimdown-miracle.com',
    actualUrl: 'https://miracle-weight-solution.net/exclusive-offer',
    buttonText: 'Claim 70% Discount Now',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cbe'),
    type: 'advertisement',
    name: 'University Online Program Advertisement',
    reason: 'Contains legitimate educational institution information with standard program details',
    title: 'Northwestern Online MBA Program - Applications Open',
    description: "Advance your career with Northwestern University's AACSB-accredited Online MBA. Learn from world-class faculty with a flexible schedule designed for working professionals. Fall 2025 applications due June 1.",                                                                                                           
    imageText: 'NORTHWESTERN KELLOGG',
    displayUrl: 'kellogg.northwestern.edu',
    actualUrl: 'https://www.kellogg.northwestern.edu/programs/online-mba.aspx',
    buttonText: 'Request Information',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cbf'),
    type: 'browser_extension',
    name: 'PDF Editor Extension with Excessive Permissions',
    reason: 'Requests unreasonable access to browsing data and financial information for a simple PDF tool',
    developer: 'QuickTools Software',
    users: '850K+',
    rating: '★★★★☆',
    description: 'Edit, annotate, and convert PDF files directly in your browser. Add text, highlight content, insert images, and sign documents with this all-in-one PDF editor. Save time with our intuitive interface and powerful features.',                                                                                            
    permissions: [
      'Read and change all your data on all websites',
      'Access your browsing history',
      'Access your payment methods',
      'Access all tabs and windows',
      'Display notifications',
      'Run in background even when browser is closed'
    ],
    reviewQuote: "Great for editing PDFs but I'm concerned about all the permissions it asks for.",
    source: 'Chrome Web Store',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cc0'),
    type: 'browser_extension',
    name: 'Language Translation Extension',
    reason: 'Requests reasonable permissions related to its core functionality with verified developer',
    developer: 'Translated Labs (Verified)',
    users: '15M+',
    rating: '★★★★★',
    description: 'Instantly translate web pages, highlighted text, and conversations in over 100 languages. Perfect for reading foreign websites, learning new languages, or communicating with people around the world.',    
    permissions: [
      'Read and change content on websites you visit',
      'Display notifications',
      'Store local data'
    ],
    reviewQuote: 'This extension has completely changed how I browse the web. I can now read content in any language with remarkable accuracy.',                                                                              
    source: 'Chrome Web Store',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cc1'),
    type: 'event_invitation',
    name: 'Cryptocurrency Trading Workshop',
    reason: 'Promises unrealistic returns and uses artificial scarcity with suspicious follow-up requirements',
    title: 'Crypto Millionaire Blueprint Workshop',
    organizer: 'Crypto Wealth Academy',
    date: 'May 10, 2025',
    time: '1:00 PM - 3:30 PM EDT',
    location: 'Virtual Webinar',
    address: 'Zoom (Link provided after registration)',
    description: 'Join our exclusive cryptocurrency trading workshop where our experts will reveal the secret strategies that have generated 500%+ returns for our private clients in just 6 months. Learn how to identify the next 100x altcoins before mainstream investors discover them. This proprietary system works in all market conditions and requires just 15 minutes per day to implement.',                                                    
    speakers: [
      {
        name: 'Michael Chang',
        title: 'Former Wall Street Trader & Crypto Millionaire'
      },
      {
        name: 'Jessica Reynolds',
        title: 'Blockchain Investment Strategist'
      }
    ],
    price: 'FREE - $197 value (Limited to first 50 registrants)',
    registerText: 'Reserve Your Spot Now (Only 7 seats left!)',
    registrationUrl: 'https://crypto-wealth-academy.net/exclusive-webinar',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cc2'),
    type: 'event_invitation',
    name: 'Community Garden Volunteer Day',
    reason: 'Contains specific local community information with legitimate organizer contact details',
    title: 'Spring Community Garden Volunteer Day',
    organizer: 'Greenwood Neighborhood Association',
    date: 'May 8, 2025',
    time: '9:00 AM - 12:00 PM',
    location: 'Greenwood Community Garden',
    address: '4235 N Lincoln Ave, Chicago, IL 60618',
    description: "Join your neighbors for our spring planting day at the Greenwood Community Garden. We'll be preparing garden beds, planting vegetables and flowers, and sprucing up the common areas. No experience necessary - tools and guidance provided! Light refreshments will be served. Children welcome with adult supervision.", 
    speakers: [],
    price: 'Free',
    registerText: 'Sign Up to Volunteer',
    registrationUrl: 'https://greenwoodchicago.org/garden-volunteer-day',
    isPhishing: false
  }
]
Type "it" for more
...
[
  {
    _id: ObjectId('6807d24deaeafbb720544cc3'),
    type: 'survey',
    name: 'Bank Satisfaction Survey with Gift Card Offer',
    reason: 'Offers unusually high reward for minimal effort and uses a domain mimicking Chase Bank',
    title: 'Chase Customer Satisfaction Survey - Win $500!',
    sponsoredBy: 'Chase Customer Experience Team',
    description: "As a valued Chase customer, you've been selected to participate in our brief customer satisfaction survey. Complete this 2-minute survey about your banking experience and you'll be entered to win a $500 Amazon gift card!",                                                                                             
    timeRequired: '2 minutes',
    questionCount: '5',
    reward: '$500 Amazon Gift Card',
    sampleQuestion: 'How satisfied are you with your overall Chase banking experience?',
    sampleOptions: [
      'Very Satisfied',
      'Satisfied',
      'Neutral',
    ...
    disclaimer: 'Winners selected weekly. Gift card will be emailed to the address provided within 24 hours of selection.',                                                                                                   
    buttonText: 'Start Survey',
    url: 'https://chase-customer-rewards.com/survey',
    isPhishing: true
  },
  {
    _id: ObjectId('6807d24deaeafbb720544cc4'),
    type: 'survey',
    name: 'Academic Research Participation Request',
    reason: 'Contains university domain with appropriate compensation and privacy details for research study',
    title: 'Psychological Research Study - Decision Making Processes',
    sponsoredBy: 'Stanford University Department of Psychology',
    description: 'You are invited to participate in a research study investigating decision-making processes in everyday situations. This study involves completing an online questionnaire about how you approach various hypothetical scenarios.',                                                                                         
    timeRequired: '20-25 minutes',
    questionCount: '45',
    reward: '$15 Amazon e-gift card',
    sampleQuestion: 'When faced with a complex decision with multiple options, do you prefer to analyze each option methodically or rely on intuition?',                                                                      
    sampleOptions: [
      'Strongly prefer methodical analysis',
      'Somewhat prefer methodical analysis',
      'Equal preference for both approaches',
      'Somewhat prefer intuition',
      'Strongly prefer intuition'
    ],
    disclaimer: 'This study has been approved by the Stanford IRB (Protocol #2025-073). Your responses will remain confidential and will be used for research purposes only.',                                                
    buttonText: 'Participate in Study',
    url: 'https://psychology.stanford.edu/research/participate/decision-making-study',
    isPhishing: false
  },
  {
    _id: ObjectId('6807d348ea41cbe9f2544ca7'),
    type: 'email',
    name: 'Password Reset Request from IT Department',
    reason: 'Uses internal company language but comes from an external domain with urgent action requirements',
    from: 'it-support@company-helpdesk.net',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544ca8'),
    type: 'email',
    name: 'Library Book Due Reminder',
    reason: 'Contains expected library language with legitimate domain and standard overdue notification format',                                                                                                             
    from: 'notifications@nypl.org',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544ca9'),
    type: 'website',
    name: 'Cloud Storage Login with Domain Typo',
    reason: "Uses 'dropobox.com' instead of legitimate 'dropbox.com' domain with very similar login page layout",                                                                                                             
    url: 'https://www.dropobox.com/login',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544caa'),
    type: 'website',
    name: 'GitHub Repository Access Page',
    reason: 'Uses legitimate GitHub domain with standard repository access form and security protocols',
    url: 'https://github.com/login?return_to=octocat/Hello-World',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cab'),
    type: 'sms',
    name: 'Account Verification Text with Short URL',
    reason: 'Creates false urgency for account verification with masked URL shortener hiding destination',
    from: '+1-503-295-8743',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cac'),
    type: 'sms',
    name: 'Delivery Notification from National Postal Service',
    reason: 'Uses official USPS shortcode with standard delivery notification format and no external links',
    from: 'USPS',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cad'),
    type: 'app_download',
    name: 'Screen Recorder Pro with Unnecessary Permissions',
    reason: 'Screen recording app requests disproportionate permissions like contacts and payment info access',
    app_name: 'Screen Recorder Pro HD',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cae'),
    type: 'app_download',
    name: 'Official Banking App with Limited Permissions',
    reason: 'Published by verified banking institution with appropriate security permissions for financial app',
    app_name: 'PNC Mobile Banking',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544caf'),
    type: 'qr_code',
    name: 'Car Rental Discount Code QR',
    reason: 'QR leads to a confusingly similar domain (enter-prize.co) instead of legitimate enterprise.com',
    title: 'Exclusive Rental Car Discount',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb0'),
    type: 'qr_code',
    name: 'Digital Concert Ticket Entry',
    reason: "Links to the venue's official domain with expected ticketing path and event information",
    title: 'Digital Ticket: Bruno Mars Concert',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb1'),
    type: 'social_media',
    name: 'Product Recall Announcement by Impersonator',
    reason: "Uses unofficial handle '@samsung.product.safety' mimicking official communication with urgent recall",                                                                                                           
    platform: 'Facebook',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb2'),
    type: 'social_media',
    name: 'City Water Service Interruption Notice',
    reason: 'Posted by verified city government account with appropriate municipal information',
    platform: 'Facebook',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb3'),
    type: 'job_offer',
    name: 'Social Media Evaluator Remote Position',
    reason: 'Offers unrealistic compensation for minimal work and requests financial information during application',                                                                                                         
    position: 'Social Media Content Evaluator',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb4'),
    type: 'job_offer',
    name: 'Data Scientist Position at Research Institution',
    reason: 'Contains specific technical requirements and reasonable salary range appropriate for the position',
    position: 'Senior Data Scientist',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb5'),
    type: 'tech_support',
    name: 'Windows Defender Virus Alert with Unusual Contact Method',
    reason: 'Creates false urgency with unusual WhatsApp contact method instead of standard Windows support',
    title: '⚠ VIRUS DETECTED - Immediate Action Required ⚠',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb6'),
    type: 'tech_support',
    name: 'Firefox Browser Update Notification',
    reason: 'Contains appropriate Mozilla branding with standard update information and no urgent action required',                                                                                                           
    title: 'Firefox Update Available',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb7'),
    type: 'document',
    name: 'Financial Statement with Macro Requirements',
    reason: 'Claims to be from a financial institution but requires enabling macros which is a security risk',
    fileName: 'Tax_Return_Summary_2024.xlsm',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb8'),
    type: 'document',
    name: 'Conference Schedule PDF',
    reason: 'Standard PDF from a recognized organization with legitimate formatting and no macro requirements',
    fileName: 'AI_Conference_Schedule_2025.pdf',
...
[
  {
    _id: ObjectId('6807d348ea41cbe9f2544cb9'),
    type: 'payment_confirmation',
    name: 'Premium Streaming Service Auto-Renewal',
    reason: "Contains subtle domain misspelling 'netflixbilling.com' instead of legitimate Netflix domain",
    company: 'Netflix',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cba'),
    type: 'payment_confirmation',
    name: 'Annual Website Domain Renewal',
    reason: 'Contains appropriate GoDaddy branding with standard domain renewal information and pricing',
    company: 'GoDaddy',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cbb'),
    type: 'security_alert',
    name: 'Account Access from Unusual Location with Custom Domain',
    reason: 'Creates urgency about account security but links to a non-official domain mimicking Google',
    title: 'Google Security Alert',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cbc'),
    type: 'security_alert',
    name: 'Legitimate Account Recovery Activity Notification',
    reason: 'Contains specific device information with standard Apple security alert formatting',
    title: 'Apple ID Recovery Attempt',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cbd'),
    type: 'advertisement',
    name: 'Miracle Weight Loss Supplement Ad',
    reason: 'Promises unrealistic quick results with artificial scarcity tactics and suspicious domain',
    title: 'MELT 30 LBS IN 30 DAYS - NO DIET OR EXERCISE!',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cbe'),
    type: 'advertisement',
    name: 'University Online Program Advertisement',
    reason: 'Contains legitimate educational institution information with standard program details',
    title: 'Northwestern Online MBA Program - Applications Open',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cbf'),
    type: 'browser_extension',
    name: 'PDF Editor Extension with Excessive Permissions',
    reason: 'Requests unreasonable access to browsing data and financial information for a simple PDF tool',
    developer: 'QuickTools Software',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cc0'),
    type: 'browser_extension',
    name: 'Language Translation Extension',
    reason: 'Requests reasonable permissions related to its core functionality with verified developer',
    developer: 'Translated Labs (Verified)',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cc1'),
    type: 'event_invitation',
    name: 'Cryptocurrency Trading Workshop',
    reason: 'Promises unrealistic returns and uses artificial scarcity with suspicious follow-up requirements',
    title: 'Crypto Millionaire Blueprint Workshop',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cc2'),
    type: 'event_invitation',
    name: 'Community Garden Volunteer Day',
    reason: 'Contains specific local community information with legitimate organizer contact details',
    title: 'Spring Community Garden Volunteer Day',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cc3'),
    type: 'survey',
    name: 'Bank Satisfaction Survey with Gift Card Offer',
    reason: 'Offers unusually high reward for minimal effort and uses a domain mimicking Chase Bank',
    title: 'Chase Customer Satisfaction Survey - Win $500!',
  ...
  {
    _id: ObjectId('6807d348ea41cbe9f2544cc4'),
    type: 'survey',
    name: 'Academic Research Participation Request',
    reason: 'Contains university domain with appropriate compensation and privacy details for research study',
    title: 'Psychological Research Study - Decision Making Processes',
